...
export function useAccountSubscription(
  baseOptions?: Apollo.SubscriptionHookOptions<AccountSubscription, AccountSubscriptionVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useSubscription<AccountSubscription, AccountSubscriptionVariables>(
    AccountDocument,
    options,
  )
}
