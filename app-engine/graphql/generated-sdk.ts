...
export function getSdk<C, E>(requester: Requester<C, E>) {
  return {
    CreateUsername(variables?: CreateUsernameMutationVariables, options?: C): Promise<CreateUsernameMutation> {
      return requester<CreateUsernameMutation, CreateUsernameMutationVariables>(CreateUsernameDocument, variables, options) as Promise<CreateUsernameMutation>;
    },
    Accounts(variables?: AccountsQueryVariables, options?: C): Promise<AccountsQuery> {
      return requester<AccountsQuery, AccountsQueryVariables>(AccountsDocument, variables, options) as Promise<AccountsQuery>;
    }
  };
}
