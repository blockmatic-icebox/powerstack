...
import {
  makeListenOptions as createListenOptions,
  createAltairConfigurations,
  createMercuriusOptions,
  createFastifyServerOptions,
  generateSwaggerOptions,
} from "./serverOptions";
...
export function createServer(opts: FastifyServerOptions = {}): FastifyInstance {
  ...
  server.register(fastifySession, {
    secret:
      ...
      "fallback-session-secrefallback-session-secrefallback-session-secret", // Use the environment variable or a fallback secret
