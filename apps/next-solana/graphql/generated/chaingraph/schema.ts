...
export type actions_select_column = 'account_disk_deltas' | 'account_ram_deltas' | 'action' | 'action_ordinal' | 'authorization' | 'chain' | 'console' | 'context_free' | 'contract' | 'data' | 'global_sequence' | 'receipt' | 'receiver' | 'transaction_id'
...
export type actions_update_column = 'account_disk_deltas' | 'account_ram_deltas' | 'action' | 'action_ordinal' | 'authorization' | 'chain' | 'console' | 'context_free' | 'contract' | 'data' | 'global_sequence' | 'receipt' | 'receiver' | 'transaction_id'
...
export type transactions_select_column = 'block_num' | 'chain' | 'cpu_usage_us' | 'net_usage' | 'net_usage_words' | 'transaction_id'
...
export type transactions_update_column = 'block_num' | 'chain' | 'cpu_usage_us' | 'net_usage' | 'net_usage_words' | 'transaction_id'
...
export type whitelists_select_column = 'actions' | 'app_id' | 'chain' | 'contract' | 'history_ready' | 'start_block' | 'tables'
...
export type whitelists_update_column = 'actions' | 'app_id' | 'chain' | 'contract' | 'history_ready' | 'start_block' | 'tables'
...
export interface actions_aggregate_fieldsGenqlSelection{
    ...
    count?: { __args: {columns?: (actions_select_column[] | null), distinct?: (Scalars['Boolean'] | null)} } | boolean | number
...
export interface actions_append_input {account_disk_deltas?: (Scalars['jsonb'] | null),account_ram_deltas?: (Scalars['jsonb'] | null),authorization?: (Scalars['jsonb'] | null),data?: (Scalars['jsonb'] | null),receipt?: (Scalars['jsonb'] | null)}
...
export interface actions_bool_exp {_and?: (actions_bool_exp[] | null),_not?: (actions_bool_exp | null),_or?: (actions_bool_exp[] | null),account_disk_deltas?: (jsonb_comparison_exp | null),account_ram_deltas?: (jsonb_comparison_exp | null),action?: (String_comparison_exp | null),action_ordinal?: (Int_comparison_exp | null),authorization?: (jsonb_comparison_exp | null),chain?: (String_comparison_exp | null),console?: (String_comparison_exp | null),context_free?: (Boolean_comparison_exp | null),contract?: (String_comparison_exp | null),data?: (jsonb_comparison_exp | null),global_sequence?: (String_comparison_exp | null),receipt?: (jsonb_comparison_exp | null),receiver?: (String_comparison_exp | null),transaction?: (transactions_bool_exp | null),transaction_id?: (String_comparison_exp | null)}


/** delete the field or element with specified path (for JSON arrays, negative integers count from the end) */
export interface actions_delete_at_path_input {account_disk_deltas?: (Scalars['String'][] | null),account_ram_deltas?: (Scalars['String'][] | null),authorization?: (Scalars['String'][] | null),data?: (Scalars['String'][] | null),receipt?: (Scalars['String'][] | null)}


/** delete the array element with specified index (negative integers count from the end). throws an error if top level container is not an array */
export interface actions_delete_elem_input {account_disk_deltas?: (Scalars['Int'] | null),account_ram_deltas?: (Scalars['Int'] | null),authorization?: (Scalars['Int'] | null),data?: (Scalars['Int'] | null),receipt?: (Scalars['Int'] | null)}


/** delete key/value pair or string element. key/value pairs are matched based on their key value */
export interface actions_delete_key_input {account_disk_deltas?: (Scalars['String'] | null),account_ram_deltas?: (Scalars['String'] | null),authorization?: (Scalars['String'] | null),data?: (Scalars['String'] | null),receipt?: (Scalars['String'] | null)}


/** input type for incrementing numeric columns in table "actions" */
export interface actions_inc_input {action_ordinal?: (Scalars['Int'] | null)}


/** input type for inserting data into table "actions" */
export interface actions_insert_input {account_disk_deltas?: (Scalars['jsonb'] | null),account_ram_deltas?: (Scalars['jsonb'] | null),action?: (Scalars['String'] | null),action_ordinal?: (Scalars['Int'] | null),authorization?: (Scalars['jsonb'] | null),chain?: (Scalars['String'] | null),console?: (Scalars['String'] | null),context_free?: (Scalars['Boolean'] | null),contract?: (Scalars['String'] | null),data?: (Scalars['jsonb'] | null),global_sequence?: (Scalars['String'] | null),receipt?: (Scalars['jsonb'] | null),receiver?: (Scalars['String'] | null),transaction?: (transactions_obj_rel_insert_input | null),transaction_id?: (Scalars['String'] | null)}
...
export interface actions_on_conflict {constraint?: actions_constraint,update_columns?: actions_update_column[],where?: (actions_bool_exp | null)}


/** Ordering options when selecting data from "actions". */
export interface actions_order_by {account_disk_deltas?: (order_by | null),account_ram_deltas?: (order_by | null),action?: (order_by | null),action_ordinal?: (order_by | null),authorization?: (order_by | null),chain?: (order_by | null),console?: (order_by | null),context_free?: (order_by | null),contract?: (order_by | null),data?: (order_by | null),global_sequence?: (order_by | null),receipt?: (order_by | null),receiver?: (order_by | null),transaction?: (transactions_order_by | null),transaction_id?: (order_by | null)}


/** primary key columns input for table: actions */
export interface actions_pk_columns_input {chain?: Scalars['String'],global_sequence?: Scalars['String']}


/** prepend existing jsonb value of filtered columns with new jsonb value */
export interface actions_prepend_input {account_disk_deltas?: (Scalars['jsonb'] | null),account_ram_deltas?: (Scalars['jsonb'] | null),authorization?: (Scalars['jsonb'] | null),data?: (Scalars['jsonb'] | null),receipt?: (Scalars['jsonb'] | null)}


/** input type for updating data in table "actions" */
export interface actions_set_input {account_disk_deltas?: (Scalars['jsonb'] | null),account_ram_deltas?: (Scalars['jsonb'] | null),action?: (Scalars['String'] | null),action_ordinal?: (Scalars['Int'] | null),authorization?: (Scalars['jsonb'] | null),chain?: (Scalars['String'] | null),console?: (Scalars['String'] | null),context_free?: (Scalars['Boolean'] | null),contract?: (Scalars['String'] | null),data?: (Scalars['jsonb'] | null),global_sequence?: (Scalars['String'] | null),receipt?: (Scalars['jsonb'] | null),receiver?: (Scalars['String'] | null),transaction_id?: (Scalars['String'] | null)}
...
export interface actions_stream_cursor_value_input {account_disk_deltas?: (Scalars['jsonb'] | null),account_ram_deltas?: (Scalars['jsonb'] | null),action?: (Scalars['String'] | null),action_ordinal?: (Scalars['Int'] | null),authorization?: (Scalars['jsonb'] | null),chain?: (Scalars['String'] | null),console?: (Scalars['String'] | null),context_free?: (Scalars['Boolean'] | null),contract?: (Scalars['String'] | null),data?: (Scalars['jsonb'] | null),global_sequence?: (Scalars['String'] | null),receipt?: (Scalars['jsonb'] | null),receiver?: (Scalars['String'] | null),transaction_id?: (Scalars['String'] | null)}
...
export interface api_users_aggregate_fieldsGenqlSelection{
    ...
    count?: { __args: {columns?: (api_users_select_column[] | null), distinct?: (Scalars['Boolean'] | null)} } | boolean | number
...
export interface api_users_bool_exp {_and?: (api_users_bool_exp[] | null),_not?: (api_users_bool_exp | null),_or?: (api_users_bool_exp[] | null),account?: (String_comparison_exp | null),api_key?: (String_comparison_exp | null),created_at?: (timestamptz_comparison_exp | null),domain_names?: (String_comparison_exp | null),id?: (Int_comparison_exp | null),updated_at?: (timestamptz_comparison_exp | null)}


/** input type for incrementing numeric columns in table "api_users" */
export interface api_users_inc_input {id?: (Scalars['Int'] | null)}


/** input type for inserting data into table "api_users" */
export interface api_users_insert_input {account?: (Scalars['String'] | null),api_key?: (Scalars['String'] | null),created_at?: (Scalars['timestamptz'] | null),domain_names?: (Scalars['String'] | null),id?: (Scalars['Int'] | null),updated_at?: (Scalars['timestamptz'] | null)}
...
export interface api_users_on_conflict {constraint?: api_users_constraint,update_columns?: api_users_update_column[],where?: (api_users_bool_exp | null)}


/** Ordering options when selecting data from "api_users". */
export interface api_users_order_by {account?: (order_by | null),api_key?: (order_by | null),created_at?: (order_by | null),domain_names?: (order_by | null),id?: (order_by | null),updated_at?: (order_by | null)}


/** primary key columns input for table: api_users */
export interface api_users_pk_columns_input {id?: Scalars['Int']}


/** input type for updating data in table "api_users" */
export interface api_users_set_input {account?: (Scalars['String'] | null),api_key?: (Scalars['String'] | null),created_at?: (Scalars['timestamptz'] | null),domain_names?: (Scalars['String'] | null),id?: (Scalars['Int'] | null),updated_at?: (Scalars['timestamptz'] | null)}
...
/** Initial value of the column from where the streaming should start */
export interface api_users_stream_cursor_value_input {account?: (Scalars['String'] | null),api_key?: (Scalars['String'] | null),created_at?: (Scalars['timestamptz'] | null),domain_names?: (Scalars['String'] | null),id?: (Scalars['Int'] | null),updated_at?: (Scalars['timestamptz'] | null)}
...
export interface blocks_aggregate_bool_exp {count?: (blocks_aggregate_bool_exp_count | null)}

export interface blocks_aggregate_bool_exp_count {arguments?: (blocks_select_column[] | null),distinct?: (Scalars['Boolean'] | null),filter?: (blocks_bool_exp | null),predicate?: Int_comparison_exp}


/** aggregate fields of "blocks" */
export interface blocks_aggregate_fieldsGenqlSelection{
    avg?: blocks_avg_fieldsGenqlSelection
    count?: { __args: {columns?: (blocks_select_column[] | null), distinct?: (Scalars['Boolean'] | null)} } | boolean | number
...
export interface blocks_aggregate_order_by {avg?: (blocks_avg_order_by | null),count?: (order_by | null),max?: (blocks_max_order_by | null),min?: (blocks_min_order_by | null),stddev?: (blocks_stddev_order_by | null),stddev_pop?: (blocks_stddev_pop_order_by | null),stddev_samp?: (blocks_stddev_samp_order_by | null),sum?: (blocks_sum_order_by | null),var_pop?: (blocks_var_pop_order_by | null),var_samp?: (blocks_var_samp_order_by | null),variance?: (blocks_variance_order_by | null)}


/** input type for inserting array relation for remote table "blocks" */
export interface blocks_arr_rel_insert_input {data?: blocks_insert_input[],
/** upsert condition */
...
export interface blocks_avg_order_by {block_num?: (order_by | null)}


/** Boolean expression to filter rows from the table "blocks". All fields are combined with a logical 'AND'. */
export interface blocks_bool_exp {_and?: (blocks_bool_exp[] | null),_not?: (blocks_bool_exp | null),_or?: (blocks_bool_exp[] | null),block_id?: (String_comparison_exp | null),block_num?: (Int_comparison_exp | null),chain?: (String_comparison_exp | null),chian?: (chains_bool_exp | null),producer?: (String_comparison_exp | null),timestamp?: (timestamptz_comparison_exp | null)}


/** input type for incrementing numeric columns in table "blocks" */
export interface blocks_inc_input {block_num?: (Scalars['Int'] | null)}


/** input type for inserting data into table "blocks" */
export interface blocks_insert_input {block_id?: (Scalars['String'] | null),block_num?: (Scalars['Int'] | null),chain?: (Scalars['String'] | null),chian?: (chains_obj_rel_insert_input | null),producer?: (Scalars['String'] | null),timestamp?: (Scalars['timestamptz'] | null)}
...
export interface blocks_max_order_by {block_id?: (order_by | null),block_num?: (order_by | null),chain?: (order_by | null),producer?: (order_by | null),timestamp?: (order_by | null)}
...
export interface blocks_min_order_by {block_id?: (order_by | null),block_num?: (order_by | null),chain?: (order_by | null),producer?: (order_by | null),timestamp?: (order_by | null)}
...
export interface blocks_on_conflict {constraint?: blocks_constraint,update_columns?: blocks_update_column[],where?: (blocks_bool_exp | null)}


/** Ordering options when selecting data from "blocks". */
export interface blocks_order_by {block_id?: (order_by | null),block_num?: (order_by | null),chain?: (order_by | null),chian?: (chains_order_by | null),producer?: (order_by | null),timestamp?: (order_by | null)}


/** primary key columns input for table: blocks */
export interface blocks_pk_columns_input {block_num?: Scalars['Int'],chain?: Scalars['String']}


/** input type for updating data in table "blocks" */
export interface blocks_set_input {block_id?: (Scalars['String'] | null),block_num?: (Scalars['Int'] | null),chain?: (Scalars['String'] | null),producer?: (Scalars['String'] | null),timestamp?: (Scalars['timestamptz'] | null)}
...
export interface blocks_stddev_order_by {block_num?: (order_by | null)}
...
export interface blocks_stddev_pop_order_by {block_num?: (order_by | null)}
...
export interface blocks_stddev_samp_order_by {block_num?: (order_by | null)}
...
/** Initial value of the column from where the streaming should start */
export interface blocks_stream_cursor_value_input {block_id?: (Scalars['String'] | null),block_num?: (Scalars['Int'] | null),chain?: (Scalars['String'] | null),producer?: (Scalars['String'] | null),timestamp?: (Scalars['timestamptz'] | null)}
...
export interface blocks_sum_order_by {block_num?: (order_by | null)}
...
export interface blocks_var_pop_order_by {block_num?: (order_by | null)}
...
export interface blocks_var_samp_order_by {block_num?: (order_by | null)}
...
export interface blocks_variance_order_by {block_num?: (order_by | null)}


/** columns and relationships of "chains" */
export interface chainsGenqlSelection{
    /** An array relationship */
    blocks?: (blocksGenqlSelection & { __args?: {
    ...
    /** An aggregate relationship */
    blocks_aggregate?: (blocks_aggregateGenqlSelection & { __args?: {
    /** distinct select on columns */
    distinct_on?: (blocks_select_column[] | null), 
    /** limit the number of rows returned */
    limit?: (Scalars['Int'] | null), 
    ...
    /** fetch data from the table: "table_rows" */
    table_rows?: (table_rowsGenqlSelection & { __args?: {
    /** distinct select on columns */
    ...
    /** fetch aggregated fields from the table: "table_rows" */
    table_rows_aggregate?: (table_rows_aggregateGenqlSelection & { __args?: {
    /** distinct select on columns */
    distinct_on?: (table_rows_select_column[] | null), 
    /** limit the number of rows returned */
    limit?: (Scalars['Int'] | null), 
...
export interface chains_aggregate_fieldsGenqlSelection{
    count?: { __args: {columns?: (chains_select_column[] | null), distinct?: (Scalars['Boolean'] | null)} } | boolean | number
...
export interface chains_bool_exp {_and?: (chains_bool_exp[] | null),_not?: (chains_bool_exp | null),_or?: (chains_bool_exp[] | null),blocks?: (blocks_bool_exp | null),blocks_aggregate?: (blocks_aggregate_bool_exp | null),chain_id?: (String_comparison_exp | null),chain_name?: (String_comparison_exp | null),rpc_endpoint?: (String_comparison_exp | null),table_rows?: (table_rows_bool_exp | null),table_rows_aggregate?: (table_rows_aggregate_bool_exp | null)}


/** input type for inserting data into table "chains" */
export interface chains_insert_input {blocks?: (blocks_arr_rel_insert_input | null),chain_id?: (Scalars['String'] | null),chain_name?: (Scalars['String'] | null),rpc_endpoint?: (Scalars['String'] | null),table_rows?: (table_rows_arr_rel_insert_input | null)}
...
export interface chains_obj_rel_insert_input {data?: chains_insert_input,
/** upsert condition */
on_conflict?: (chains_on_conflict | null)}


/** on_conflict condition type for table "chains" */
export interface chains_on_conflict {constraint?: chains_constraint,update_columns?: chains_update_column[],where?: (chains_bool_exp | null)}


/** Ordering options when selecting data from "chains". */
export interface chains_order_by {blocks_aggregate?: (blocks_aggregate_order_by | null),chain_id?: (order_by | null),chain_name?: (order_by | null),rpc_endpoint?: (order_by | null),table_rows_aggregate?: (table_rows_aggregate_order_by | null)}


/** primary key columns input for table: chains */
export interface chains_pk_columns_input {chain_name?: Scalars['String']}


/** input type for updating data in table "chains" */
export interface chains_set_input {chain_id?: (Scalars['String'] | null),chain_name?: (Scalars['String'] | null),rpc_endpoint?: (Scalars['String'] | null)}
...
/** Initial value of the column from where the streaming should start */
export interface chains_stream_cursor_value_input {chain_id?: (Scalars['String'] | null),chain_name?: (Scalars['String'] | null),rpc_endpoint?: (Scalars['String'] | null)}
...
export interface manifests_aggregate_fieldsGenqlSelection{
    count?: { __args: {columns?: (manifests_select_column[] | null), distinct?: (Scalars['Boolean'] | null)} } | boolean | number
...
export interface manifests_bool_exp {_and?: (manifests_bool_exp[] | null),_not?: (manifests_bool_exp | null),_or?: (manifests_bool_exp[] | null),app_id?: (uuid_comparison_exp | null),app_name?: (String_comparison_exp | null),description?: (String_comparison_exp | null),url?: (String_comparison_exp | null)}


/** input type for inserting data into table "manifests" */
export interface manifests_insert_input {app_id?: (Scalars['uuid'] | null),app_name?: (Scalars['String'] | null),description?: (Scalars['String'] | null),url?: (Scalars['String'] | null)}
...
export interface manifests_obj_rel_insert_input {data?: manifests_insert_input,
/** upsert condition */
on_conflict?: (manifests_on_conflict | null)}


/** on_conflict condition type for table "manifests" */
export interface manifests_on_conflict {constraint?: manifests_constraint,update_columns?: manifests_update_column[],where?: (manifests_bool_exp | null)}


/** Ordering options when selecting data from "manifests". */
export interface manifests_order_by {app_id?: (order_by | null),app_name?: (order_by | null),description?: (order_by | null),url?: (order_by | null)}


/** primary key columns input for table: manifests */
export interface manifests_pk_columns_input {app_id?: Scalars['uuid']}


/** input type for updating data in table "manifests" */
export interface manifests_set_input {app_id?: (Scalars['uuid'] | null),app_name?: (Scalars['String'] | null),description?: (Scalars['String'] | null),url?: (Scalars['String'] | null)}
...
/** Initial value of the column from where the streaming should start */
export interface manifests_stream_cursor_value_input {app_id?: (Scalars['uuid'] | null),app_name?: (Scalars['String'] | null),description?: (Scalars['String'] | null),url?: (Scalars['String'] | null)}
...
export interface mappings_aggregate_fieldsGenqlSelection{
    count?: { __args: {columns?: (mappings_select_column[] | null), distinct?: (Scalars['Boolean'] | null)} } | boolean | number
...
/** append existing jsonb value of filtered columns with new jsonb value */
export interface mappings_append_input {abi?: (Scalars['jsonb'] | null),tables?: (Scalars['jsonb'] | null)}


/** Boolean expression to filter rows from the table "mappings". All fields are combined with a logical 'AND'. */
export interface mappings_bool_exp {_and?: (mappings_bool_exp[] | null),_not?: (mappings_bool_exp | null),_or?: (mappings_bool_exp[] | null),abi?: (jsonb_comparison_exp | null),chain?: (String_comparison_exp | null),contract?: (String_comparison_exp | null),contract_type?: (String_comparison_exp | null),tables?: (jsonb_comparison_exp | null)}


/** delete the field or element with specified path (for JSON arrays, negative integers count from the end) */
export interface mappings_delete_at_path_input {abi?: (Scalars['String'][] | null),tables?: (Scalars['String'][] | null)}


/** delete the array element with specified index (negative integers count from the end). throws an error if top level container is not an array */
export interface mappings_delete_elem_input {abi?: (Scalars['Int'] | null),tables?: (Scalars['Int'] | null)}


/** delete key/value pair or string element. key/value pairs are matched based on their key value */
export interface mappings_delete_key_input {abi?: (Scalars['String'] | null),tables?: (Scalars['String'] | null)}


/** input type for inserting data into table "mappings" */
export interface mappings_insert_input {abi?: (Scalars['jsonb'] | null),chain?: (Scalars['String'] | null),contract?: (Scalars['String'] | null),contract_type?: (Scalars['String'] | null),tables?: (Scalars['jsonb'] | null)}
...
export interface mappings_on_conflict {constraint?: mappings_constraint,update_columns?: mappings_update_column[],where?: (mappings_bool_exp | null)}


/** Ordering options when selecting data from "mappings". */
export interface mappings_order_by {abi?: (order_by | null),chain?: (order_by | null),contract?: (order_by | null),contract_type?: (order_by | null),tables?: (order_by | null)}


/** primary key columns input for table: mappings */
export interface mappings_pk_columns_input {chain?: Scalars['String'],contract?: Scalars['String']}


/** prepend existing jsonb value of filtered columns with new jsonb value */
export interface mappings_prepend_input {abi?: (Scalars['jsonb'] | null),tables?: (Scalars['jsonb'] | null)}


/** input type for updating data in table "mappings" */
export interface mappings_set_input {abi?: (Scalars['jsonb'] | null),chain?: (Scalars['String'] | null),contract?: (Scalars['String'] | null),contract_type?: (Scalars['String'] | null),tables?: (Scalars['jsonb'] | null)}
...
/** Initial value of the column from where the streaming should start */
export interface mappings_stream_cursor_value_input {abi?: (Scalars['jsonb'] | null),chain?: (Scalars['String'] | null),contract?: (Scalars['String'] | null),contract_type?: (Scalars['String'] | null),tables?: (Scalars['jsonb'] | null)}
...
export interface mutation_rootGenqlSelection{
    /** delete data from the table: "actions" */
    delete_actions?: (actions_mutation_responseGenqlSelection & { __args: {
    /** filter the rows which have to be deleted */
    where: actions_bool_exp} })
    /** delete single row from the table: "actions" */
    delete_actions_by_pk?: (actionsGenqlSelection & { __args: {chain: Scalars['String'], global_sequence: Scalars['String']} })
    /** delete data from the table: "api_users" */
    delete_api_users?: (api_users_mutation_responseGenqlSelection & { __args: {
    /** filter the rows which have to be deleted */
    where: api_users_bool_exp} })
    /** delete single row from the table: "api_users" */
    delete_api_users_by_pk?: (api_usersGenqlSelection & { __args: {id: Scalars['Int']} })
    /** delete data from the table: "blocks" */
    delete_blocks?: (blocks_mutation_responseGenqlSelection & { __args: {
    /** filter the rows which have to be deleted */
    where: blocks_bool_exp} })
    /** delete single row from the table: "blocks" */
    delete_blocks_by_pk?: (blocksGenqlSelection & { __args: {block_num: Scalars['Int'], chain: Scalars['String']} })
    /** delete data from the table: "chains" */
    delete_chains?: (chains_mutation_responseGenqlSelection & { __args: {
    /** filter the rows which have to be deleted */
    where: chains_bool_exp} })
    /** delete single row from the table: "chains" */
    delete_chains_by_pk?: (chainsGenqlSelection & { __args: {chain_name: Scalars['String']} })
    /** delete data from the table: "manifests" */
    delete_manifests?: (manifests_mutation_responseGenqlSelection & { __args: {
    /** filter the rows which have to be deleted */
    where: manifests_bool_exp} })
    /** delete single row from the table: "manifests" */
    delete_manifests_by_pk?: (manifestsGenqlSelection & { __args: {app_id: Scalars['uuid']} })
    /** delete data from the table: "mappings" */
    delete_mappings?: (mappings_mutation_responseGenqlSelection & { __args: {
    /** filter the rows which have to be deleted */
    where: mappings_bool_exp} })
    /** delete single row from the table: "mappings" */
    delete_mappings_by_pk?: (mappingsGenqlSelection & { __args: {chain: Scalars['String'], contract: Scalars['String']} })
    /** delete data from the table: "table_rows" */
    delete_table_rows?: (table_rows_mutation_responseGenqlSelection & { __args: {
    /** filter the rows which have to be deleted */
    where: table_rows_bool_exp} })
    /** delete single row from the table: "table_rows" */
    delete_table_rows_by_pk?: (table_rowsGenqlSelection & { __args: {chain: Scalars['String'], contract: Scalars['String'], primary_key: Scalars['String'], scope: Scalars['String'], table: Scalars['String']} })
    /** delete data from the table: "transactions" */
    delete_transactions?: (transactions_mutation_responseGenqlSelection & { __args: {
    /** filter the rows which have to be deleted */
    where: transactions_bool_exp} })
    /** delete single row from the table: "transactions" */
    delete_transactions_by_pk?: (transactionsGenqlSelection & { __args: {chain: Scalars['String'], transaction_id: Scalars['String']} })
    /** delete data from the table: "whitelists" */
    delete_whitelists?: (whitelists_mutation_responseGenqlSelection & { __args: {
    /** filter the rows which have to be deleted */
    where: whitelists_bool_exp} })
    /** delete single row from the table: "whitelists" */
    delete_whitelists_by_pk?: (whitelistsGenqlSelection & { __args: {app_id: Scalars['uuid'], chain: Scalars['String'], contract: Scalars['String']} })
    /** insert data into the table: "actions" */
    insert_actions?: (actions_mutation_responseGenqlSelection & { __args: {
    /** the rows to be inserted */
    objects: actions_insert_input[], 
    /** upsert condition */
    on_conflict?: (actions_on_conflict | null)} })
    /** insert a single row into the table: "actions" */
    insert_actions_one?: (actionsGenqlSelection & { __args: {
    /** the row to be inserted */
    object: actions_insert_input, 
    /** upsert condition */
    on_conflict?: (actions_on_conflict | null)} })
    /** insert data into the table: "api_users" */
    insert_api_users?: (api_users_mutation_responseGenqlSelection & { __args: {
    /** the rows to be inserted */
    objects: api_users_insert_input[], 
    /** upsert condition */
    on_conflict?: (api_users_on_conflict | null)} })
    /** insert a single row into the table: "api_users" */
    insert_api_users_one?: (api_usersGenqlSelection & { __args: {
    /** the row to be inserted */
    object: api_users_insert_input, 
    /** upsert condition */
    on_conflict?: (api_users_on_conflict | null)} })
    /** insert data into the table: "blocks" */
    insert_blocks?: (blocks_mutation_responseGenqlSelection & { __args: {
    /** the rows to be inserted */
    objects: blocks_insert_input[], 
    /** upsert condition */
    on_conflict?: (blocks_on_conflict | null)} })
    /** insert a single row into the table: "blocks" */
    insert_blocks_one?: (blocksGenqlSelection & { __args: {
    /** the row to be inserted */
    object: blocks_insert_input, 
    /** upsert condition */
    on_conflict?: (blocks_on_conflict | null)} })
    /** insert data into the table: "chains" */
    insert_chains?: (chains_mutation_responseGenqlSelection & { __args: {
    /** the rows to be inserted */
    objects: chains_insert_input[], 
    /** upsert condition */
    on_conflict?: (chains_on_conflict | null)} })
    /** insert a single row into the table: "chains" */
    insert_chains_one?: (chainsGenqlSelection & { __args: {
    /** the row to be inserted */
    object: chains_insert_input, 
    /** upsert condition */
    on_conflict?: (chains_on_conflict | null)} })
    /** insert data into the table: "manifests" */
    insert_manifests?: (manifests_mutation_responseGenqlSelection & { __args: {
    /** the rows to be inserted */
    objects: manifests_insert_input[], 
    /** upsert condition */
    on_conflict?: (manifests_on_conflict | null)} })
    /** insert a single row into the table: "manifests" */
    insert_manifests_one?: (manifestsGenqlSelection & { __args: {
    /** the row to be inserted */
    object: manifests_insert_input, 
    /** upsert condition */
    on_conflict?: (manifests_on_conflict | null)} })
    /** insert data into the table: "mappings" */
    insert_mappings?: (mappings_mutation_responseGenqlSelection & { __args: {
    /** the rows to be inserted */
    objects: mappings_insert_input[], 
    /** upsert condition */
    on_conflict?: (mappings_on_conflict | null)} })
    /** insert a single row into the table: "mappings" */
    insert_mappings_one?: (mappingsGenqlSelection & { __args: {
    /** the row to be inserted */
    object: mappings_insert_input, 
    /** upsert condition */
    on_conflict?: (mappings_on_conflict | null)} })
    /** insert data into the table: "table_rows" */
    insert_table_rows?: (table_rows_mutation_responseGenqlSelection & { __args: {
    /** the rows to be inserted */
    objects: table_rows_insert_input[], 
    /** upsert condition */
    on_conflict?: (table_rows_on_conflict | null)} })
    /** insert a single row into the table: "table_rows" */
    insert_table_rows_one?: (table_rowsGenqlSelection & { __args: {
    /** the row to be inserted */
    ...
    on_conflict?: (transactions_on_conflict | null)} })
    /** insert data into the table: "whitelists" */
    insert_whitelists?: (whitelists_mutation_responseGenqlSelection & { __args: {
    /** the rows to be inserted */
    objects: whitelists_insert_input[], 
    /** upsert condition */
    on_conflict?: (whitelists_on_conflict | null)} })
    /** insert a single row into the table: "whitelists" */
    insert_whitelists_one?: (whitelistsGenqlSelection & { __args: {
    /** the row to be inserted */
    object: whitelists_insert_input, 
    /** upsert condition */
    on_conflict?: (whitelists_on_conflict | null)} })
    /** update data of the table: "actions" */
    update_actions?: (actions_mutation_responseGenqlSelection & { __args: {
    /** append existing jsonb value of filtered columns with new jsonb value */
    _append?: (actions_append_input | null), 
    /** delete the field or element with specified path (for JSON arrays, negative integers count from the end) */
    _delete_at_path?: (actions_delete_at_path_input | null), 
    ...
    where: actions_bool_exp} })
    /** update single row of the table: "actions" */
    update_actions_by_pk?: (actionsGenqlSelection & { __args: {
    /** append existing jsonb value of filtered columns with new jsonb value */
    _append?: (actions_append_input | null), 
    /** delete the field or element with specified path (for JSON arrays, negative integers count from the end) */
    _delete_at_path?: (actions_delete_at_path_input | null), 
    ...
    _prepend?: (actions_prepend_input | null), 
    /** sets the columns of the filtered rows to the given values */
    _set?: (actions_set_input | null), pk_columns: actions_pk_columns_input} })
    /** update multiples rows of table: "actions" */
    update_actions_many?: (actions_mutation_responseGenqlSelection & { __args: {
    /** updates to execute, in order */
    updates: actions_updates[]} })
    /** update data of the table: "api_users" */
    update_api_users?: (api_users_mutation_responseGenqlSelection & { __args: {
    /** increments the numeric columns with given value of the filtered values */
    _inc?: (api_users_inc_input | null), 
    /** sets the columns of the filtered rows to the given values */
    ...
    where: api_users_bool_exp} })
    /** update single row of the table: "api_users" */
    update_api_users_by_pk?: (api_usersGenqlSelection & { __args: {
    /** increments the numeric columns with given value of the filtered values */
    _inc?: (api_users_inc_input | null), 
    /** sets the columns of the filtered rows to the given values */
    _set?: (api_users_set_input | null), pk_columns: api_users_pk_columns_input} })
    /** update multiples rows of table: "api_users" */
    update_api_users_many?: (api_users_mutation_responseGenqlSelection & { __args: {
    /** updates to execute, in order */
    updates: api_users_updates[]} })
    /** update data of the table: "blocks" */
    update_blocks?: (blocks_mutation_responseGenqlSelection & { __args: {
    /** increments the numeric columns with given value of the filtered values */
    _inc?: (blocks_inc_input | null), 
    /** sets the columns of the filtered rows to the given values */
    ...
    where: blocks_bool_exp} })
    /** update single row of the table: "blocks" */
    update_blocks_by_pk?: (blocksGenqlSelection & { __args: {
    /** increments the numeric columns with given value of the filtered values */
    _inc?: (blocks_inc_input | null), 
    /** sets the columns of the filtered rows to the given values */
    _set?: (blocks_set_input | null), pk_columns: blocks_pk_columns_input} })
    /** update multiples rows of table: "blocks" */
    update_blocks_many?: (blocks_mutation_responseGenqlSelection & { __args: {
    /** updates to execute, in order */
    updates: blocks_updates[]} })
    /** update data of the table: "chains" */
    update_chains?: (chains_mutation_responseGenqlSelection & { __args: {
    /** sets the columns of the filtered rows to the given values */
    _set?: (chains_set_input | null), 
    /** filter the rows which have to be updated */
    where: chains_bool_exp} })
    /** update single row of the table: "chains" */
    update_chains_by_pk?: (chainsGenqlSelection & { __args: {
    /** sets the columns of the filtered rows to the given values */
    _set?: (chains_set_input | null), pk_columns: chains_pk_columns_input} })
    /** update multiples rows of table: "chains" */
    update_chains_many?: (chains_mutation_responseGenqlSelection & { __args: {
    /** updates to execute, in order */
    updates: chains_updates[]} })
    /** update data of the table: "manifests" */
    update_manifests?: (manifests_mutation_responseGenqlSelection & { __args: {
    /** sets the columns of the filtered rows to the given values */
    _set?: (manifests_set_input | null), 
    /** filter the rows which have to be updated */
    where: manifests_bool_exp} })
    /** update single row of the table: "manifests" */
    update_manifests_by_pk?: (manifestsGenqlSelection & { __args: {
    /** sets the columns of the filtered rows to the given values */
    _set?: (manifests_set_input | null), pk_columns: manifests_pk_columns_input} })
    /** update multiples rows of table: "manifests" */
    update_manifests_many?: (manifests_mutation_responseGenqlSelection & { __args: {
    /** updates to execute, in order */
    updates: manifests_updates[]} })
    /** update data of the table: "mappings" */
    update_mappings?: (mappings_mutation_responseGenqlSelection & { __args: {
    /** append existing jsonb value of filtered columns with new jsonb value */
    _append?: (mappings_append_input | null), 
    /** delete the field or element with specified path (for JSON arrays, negative integers count from the end) */
    _delete_at_path?: (mappings_delete_at_path_input | null), 
    ...
    where: mappings_bool_exp} })
    /** update single row of the table: "mappings" */
    update_mappings_by_pk?: (mappingsGenqlSelection & { __args: {
    /** append existing jsonb value of filtered columns with new jsonb value */
    _append?: (mappings_append_input | null), 
    /** delete the field or element with specified path (for JSON arrays, negative integers count from the end) */
    _delete_at_path?: (mappings_delete_at_path_input | null), 
    ...
    _prepend?: (mappings_prepend_input | null), 
    /** sets the columns of the filtered rows to the given values */
    _set?: (mappings_set_input | null), pk_columns: mappings_pk_columns_input} })
    /** update multiples rows of table: "mappings" */
    update_mappings_many?: (mappings_mutation_responseGenqlSelection & { __args: {
    /** updates to execute, in order */
    updates: mappings_updates[]} })
    /** update data of the table: "table_rows" */
    update_table_rows?: (table_rows_mutation_responseGenqlSelection & { __args: {
    /** append existing jsonb value of filtered columns with new jsonb value */
    ...
    where: table_rows_bool_exp} })
    /** update single row of the table: "table_rows" */
    update_table_rows_by_pk?: (table_rowsGenqlSelection & { __args: {
    /** append existing jsonb value of filtered columns with new jsonb value */
    _append?: (table_rows_append_input | null), 
    /** delete the field or element with specified path (for JSON arrays, negative integers count from the end) */
    _delete_at_path?: (table_rows_delete_at_path_input | null), 
    ...
    _prepend?: (table_rows_prepend_input | null), 
    /** sets the columns of the filtered rows to the given values */
    _set?: (table_rows_set_input | null), pk_columns: table_rows_pk_columns_input} })
    /** update multiples rows of table: "table_rows" */
    update_table_rows_many?: (table_rows_mutation_responseGenqlSelection & { __args: {
    /** updates to execute, in order */
    ...
    /** update data of the table: "whitelists" */
    update_whitelists?: (whitelists_mutation_responseGenqlSelection & { __args: {
    /** append existing jsonb value of filtered columns with new jsonb value */
    ...
    where: whitelists_bool_exp} })
    /** update single row of the table: "whitelists" */
    update_whitelists_by_pk?: (whitelistsGenqlSelection & { __args: {
    /** append existing jsonb value of filtered columns with new jsonb value */
    _append?: (whitelists_append_input | null), 
    /** delete the field or element with specified path (for JSON arrays, negative integers count from the end) */
    _delete_at_path?: (whitelists_delete_at_path_input | null), 
    ...
    _prepend?: (whitelists_prepend_input | null), 
    /** sets the columns of the filtered rows to the given values */
    _set?: (whitelists_set_input | null), pk_columns: whitelists_pk_columns_input} })
    /** update multiples rows of table: "whitelists" */
    update_whitelists_many?: (whitelists_mutation_responseGenqlSelection & { __args: {
    /** updates to execute, in order */
...
export interface query_rootGenqlSelection{
    /** fetch data from the table: "actions" */
    actions?: (actionsGenqlSelection & { __args?: {
    /** distinct select on columns */
    ...
    /** fetch aggregated fields from the table: "actions" */
    actions_aggregate?: (actions_aggregateGenqlSelection & { __args?: {
    /** distinct select on columns */
    distinct_on?: (actions_select_column[] | null), 
    /** limit the number of rows returned */
    limit?: (Scalars['Int'] | null), 
    ...
    where?: (actions_bool_exp | null)} })
    /** fetch data from the table: "actions" using primary key columns */
    actions_by_pk?: (actionsGenqlSelection & { __args: {chain: Scalars['String'], global_sequence: Scalars['String']} })
    /** fetch data from the table: "api_users" */
    api_users?: (api_usersGenqlSelection & { __args?: {
    /** distinct select on columns */
    ...
    /** fetch aggregated fields from the table: "api_users" */
    api_users_aggregate?: (api_users_aggregateGenqlSelection & { __args?: {
    /** distinct select on columns */
    distinct_on?: (api_users_select_column[] | null), 
    /** limit the number of rows returned */
    limit?: (Scalars['Int'] | null), 
    ...
    where?: (blocks_bool_exp | null)} })
    /** fetch data from the table: "blocks" using primary key columns */
    blocks_by_pk?: (blocksGenqlSelection & { __args: {block_num: Scalars['Int'], chain: Scalars['String']} })
    /** fetch data from the table: "chains" */
    chains?: (chainsGenqlSelection & { __args?: {
    /** distinct select on columns */
    ...
    /** fetch aggregated fields from the table: "chains" */
    chains_aggregate?: (chains_aggregateGenqlSelection & { __args?: {
    /** distinct select on columns */
    distinct_on?: (chains_select_column[] | null), 
    /** limit the number of rows returned */
    limit?: (Scalars['Int'] | null), 
    ...
    where?: (chains_bool_exp | null)} })
    /** fetch data from the table: "chains" using primary key columns */
    chains_by_pk?: (chainsGenqlSelection & { __args: {chain_name: Scalars['String']} })
    /** fetch data from the table: "manifests" */
    manifests?: (manifestsGenqlSelection & { __args?: {
    /** distinct select on columns */
    ...
    /** fetch aggregated fields from the table: "manifests" */
    manifests_aggregate?: (manifests_aggregateGenqlSelection & { __args?: {
    /** distinct select on columns */
    distinct_on?: (manifests_select_column[] | null), 
    /** limit the number of rows returned */
    limit?: (Scalars['Int'] | null), 
    ...
    where?: (manifests_bool_exp | null)} })
    /** fetch data from the table: "manifests" using primary key columns */
    manifests_by_pk?: (manifestsGenqlSelection & { __args: {app_id: Scalars['uuid']} })
    /** fetch data from the table: "mappings" */
    mappings?: (mappingsGenqlSelection & { __args?: {
    /** distinct select on columns */
    ...
    /** fetch aggregated fields from the table: "mappings" */
    mappings_aggregate?: (mappings_aggregateGenqlSelection & { __args?: {
    /** distinct select on columns */
    distinct_on?: (mappings_select_column[] | null), 
    /** limit the number of rows returned */
    limit?: (Scalars['Int'] | null), 
    ...
    where?: (mappings_bool_exp | null)} })
    /** fetch data from the table: "mappings" using primary key columns */
    mappings_by_pk?: (mappingsGenqlSelection & { __args: {chain: Scalars['String'], contract: Scalars['String']} })
    /** fetch data from the table: "table_rows" */
    table_rows?: (table_rowsGenqlSelection & { __args?: {
    /** distinct select on columns */
    distinct_on?: (table_rows_select_column[] | null), 
    ...
    where?: (table_rows_bool_exp | null)} })
    /** fetch data from the table: "table_rows" using primary key columns */
    table_rows_by_pk?: (table_rowsGenqlSelection & { __args: {chain: Scalars['String'], contract: Scalars['String'], primary_key: Scalars['String'], scope: Scalars['String'], table: Scalars['String']} })
    /** fetch data from the table: "transactions" */
    ...
    where?: (transactions_bool_exp | null)} })
    /** fetch data from the table: "transactions" using primary key columns */
    transactions_by_pk?: (transactionsGenqlSelection & { __args: {chain: Scalars['String'], transaction_id: Scalars['String']} })
    /** fetch data from the table: "whitelists" */
    whitelists?: (whitelistsGenqlSelection & { __args?: {
    /** distinct select on columns */
    ...
    /** fetch aggregated fields from the table: "whitelists" */
    whitelists_aggregate?: (whitelists_aggregateGenqlSelection & { __args?: {
    /** distinct select on columns */
    distinct_on?: (whitelists_select_column[] | null), 
    /** limit the number of rows returned */
    limit?: (Scalars['Int'] | null), 
    ...
    where?: (whitelists_bool_exp | null)} })
    /** fetch data from the table: "whitelists" using primary key columns */
    whitelists_by_pk?: (whitelistsGenqlSelection & { __args: {app_id: Scalars['uuid'], chain: Scalars['String'], contract: Scalars['String']} })
    __typename?: boolean | number
    __scalar?: boolean | number
}
...
export interface subscription_rootGenqlSelection{
    ...
    actions_by_pk?: (actionsGenqlSelection & { __args: {chain: Scalars['String'], global_sequence: Scalars['String']} })
    /** fetch data from the table in a streaming manner: "actions" */
    actions_stream?: (actionsGenqlSelection & { __args: {
    ...
    api_users_by_pk?: (api_usersGenqlSelection & { __args: {id: Scalars['Int']} })
    /** fetch data from the table in a streaming manner: "api_users" */
    api_users_stream?: (api_usersGenqlSelection & { __args: {
    /** maximum number of rows returned in a single batch */
    batch_size: Scalars['Int'], 
    /** cursor to stream the results returned by the query */
    ...
    blocks_by_pk?: (blocksGenqlSelection & { __args: {block_num: Scalars['Int'], chain: Scalars['String']} })
    /** fetch data from the table in a streaming manner: "blocks" */
    blocks_stream?: (blocksGenqlSelection & { __args: {
    /** maximum number of rows returned in a single batch */
    batch_size: Scalars['Int'], 
    /** cursor to stream the results returned by the query */
    ...
    chains_by_pk?: (chainsGenqlSelection & { __args: {chain_name: Scalars['String']} })
    /** fetch data from the table in a streaming manner: "chains" */
    chains_stream?: (chainsGenqlSelection & { __args: {
    /** maximum number of rows returned in a single batch */
    batch_size: Scalars['Int'], 
    /** cursor to stream the results returned by the query */
    ...
    manifests_by_pk?: (manifestsGenqlSelection & { __args: {app_id: Scalars['uuid']} })
    /** fetch data from the table in a streaming manner: "manifests" */
    manifests_stream?: (manifestsGenqlSelection & { __args: {
    /** maximum number of rows returned in a single batch */
    batch_size: Scalars['Int'], 
    /** cursor to stream the results returned by the query */
    ...
    mappings_by_pk?: (mappingsGenqlSelection & { __args: {chain: Scalars['String'], contract: Scalars['String']} })
    /** fetch data from the table in a streaming manner: "mappings" */
    mappings_stream?: (mappingsGenqlSelection & { __args: {
    /** maximum number of rows returned in a single batch */
    batch_size: Scalars['Int'], 
    /** cursor to stream the results returned by the query */
    ...
    table_rows_by_pk?: (table_rowsGenqlSelection & { __args: {chain: Scalars['String'], contract: Scalars['String'], primary_key: Scalars['String'], scope: Scalars['String'], table: Scalars['String']} })
    /** fetch data from the table in a streaming manner: "table_rows" */
    table_rows_stream?: (table_rowsGenqlSelection & { __args: {
    /** maximum number of rows returned in a single batch */
    batch_size: Scalars['Int'], 
    /** cursor to stream the results returned by the query */
    ...
    whitelists_by_pk?: (whitelistsGenqlSelection & { __args: {app_id: Scalars['uuid'], chain: Scalars['String'], contract: Scalars['String']} })
    /** fetch data from the table in a streaming manner: "whitelists" */
    whitelists_stream?: (whitelistsGenqlSelection & { __args: {
    /** maximum number of rows returned in a single batch */
    batch_size: Scalars['Int'], 
    /** cursor to stream the results returned by the query */
...
export interface table_rows_aggregate_bool_exp {count?: (table_rows_aggregate_bool_exp_count | null)}

export interface table_rows_aggregate_bool_exp_count {arguments?: (table_rows_select_column[] | null),distinct?: (Scalars['Boolean'] | null),filter?: (table_rows_bool_exp | null),predicate?: Int_comparison_exp}


/** aggregate fields of "table_rows" */
export interface table_rows_aggregate_fieldsGenqlSelection{
    count?: { __args: {columns?: (table_rows_select_column[] | null), distinct?: (Scalars['Boolean'] | null)} } | boolean | number
...
export interface table_rows_aggregate_order_by {count?: (order_by | null),max?: (table_rows_max_order_by | null),min?: (table_rows_min_order_by | null)}


/** append existing jsonb value of filtered columns with new jsonb value */
export interface table_rows_append_input {data?: (Scalars['jsonb'] | null)}


/** input type for inserting array relation for remote table "table_rows" */
export interface table_rows_arr_rel_insert_input {data?: table_rows_insert_input[],
/** upsert condition */
on_conflict?: (table_rows_on_conflict | null)}


/** Boolean expression to filter rows from the table "table_rows". All fields are combined with a logical 'AND'. */
export interface table_rows_bool_exp {_and?: (table_rows_bool_exp[] | null),_not?: (table_rows_bool_exp | null),_or?: (table_rows_bool_exp[] | null),chain?: (String_comparison_exp | null),contract?: (String_comparison_exp | null),data?: (jsonb_comparison_exp | null),primary_key?: (String_comparison_exp | null),scope?: (String_comparison_exp | null),table?: (String_comparison_exp | null)}


/** delete the field or element with specified path (for JSON arrays, negative integers count from the end) */
export interface table_rows_delete_at_path_input {data?: (Scalars['String'][] | null)}


/** delete the array element with specified index (negative integers count from the end). throws an error if top level container is not an array */
export interface table_rows_delete_elem_input {data?: (Scalars['Int'] | null)}


/** delete key/value pair or string element. key/value pairs are matched based on their key value */
export interface table_rows_delete_key_input {data?: (Scalars['String'] | null)}


/** input type for inserting data into table "table_rows" */
export interface table_rows_insert_input {chain?: (Scalars['String'] | null),contract?: (Scalars['String'] | null),data?: (Scalars['jsonb'] | null),primary_key?: (Scalars['String'] | null),scope?: (Scalars['String'] | null),table?: (Scalars['String'] | null)}
...
export interface table_rows_max_order_by {chain?: (order_by | null),contract?: (order_by | null),primary_key?: (order_by | null),scope?: (order_by | null),table?: (order_by | null)}
...
export interface table_rows_min_order_by {chain?: (order_by | null),contract?: (order_by | null),primary_key?: (order_by | null),scope?: (order_by | null),table?: (order_by | null)}
...
export interface table_rows_on_conflict {constraint?: table_rows_constraint,update_columns?: table_rows_update_column[],where?: (table_rows_bool_exp | null)}


/** Ordering options when selecting data from "table_rows". */
export interface table_rows_order_by {chain?: (order_by | null),contract?: (order_by | null),data?: (order_by | null),primary_key?: (order_by | null),scope?: (order_by | null),table?: (order_by | null)}


/** primary key columns input for table: table_rows */
export interface table_rows_pk_columns_input {chain?: Scalars['String'],contract?: Scalars['String'],primary_key?: Scalars['String'],scope?: Scalars['String'],table?: Scalars['String']}


/** prepend existing jsonb value of filtered columns with new jsonb value */
export interface table_rows_prepend_input {data?: (Scalars['jsonb'] | null)}


/** input type for updating data in table "table_rows" */
export interface table_rows_set_input {chain?: (Scalars['String'] | null),contract?: (Scalars['String'] | null),data?: (Scalars['jsonb'] | null),primary_key?: (Scalars['String'] | null),scope?: (Scalars['String'] | null),table?: (Scalars['String'] | null)}
...
/** Initial value of the column from where the streaming should start */
export interface table_rows_stream_cursor_value_input {chain?: (Scalars['String'] | null),contract?: (Scalars['String'] | null),data?: (Scalars['jsonb'] | null),primary_key?: (Scalars['String'] | null),scope?: (Scalars['String'] | null),table?: (Scalars['String'] | null)}
...
export interface transactions_bool_exp {_and?: (transactions_bool_exp[] | null),_not?: (transactions_bool_exp | null),_or?: (transactions_bool_exp[] | null),block_num?: (Int_comparison_exp | null),chain?: (String_comparison_exp | null),cpu_usage_us?: (Int_comparison_exp | null),net_usage?: (Int_comparison_exp | null),net_usage_words?: (Int_comparison_exp | null),transaction_id?: (String_comparison_exp | null)}


/** input type for incrementing numeric columns in table "transactions" */
export interface transactions_inc_input {block_num?: (Scalars['Int'] | null),cpu_usage_us?: (Scalars['Int'] | null),net_usage?: (Scalars['Int'] | null),net_usage_words?: (Scalars['Int'] | null)}


/** input type for inserting data into table "transactions" */
export interface transactions_insert_input {block_num?: (Scalars['Int'] | null),chain?: (Scalars['String'] | null),cpu_usage_us?: (Scalars['Int'] | null),net_usage?: (Scalars['Int'] | null),net_usage_words?: (Scalars['Int'] | null),transaction_id?: (Scalars['String'] | null)}
...
export interface transactions_order_by {block_num?: (order_by | null),chain?: (order_by | null),cpu_usage_us?: (order_by | null),net_usage?: (order_by | null),net_usage_words?: (order_by | null),transaction_id?: (order_by | null)}


/** primary key columns input for table: transactions */
export interface transactions_pk_columns_input {chain?: Scalars['String'],transaction_id?: Scalars['String']}


/** input type for updating data in table "transactions" */
export interface transactions_set_input {block_num?: (Scalars['Int'] | null),chain?: (Scalars['String'] | null),cpu_usage_us?: (Scalars['Int'] | null),net_usage?: (Scalars['Int'] | null),net_usage_words?: (Scalars['Int'] | null),transaction_id?: (Scalars['String'] | null)}
...
/** Initial value of the column from where the streaming should start */
export interface transactions_stream_cursor_value_input {block_num?: (Scalars['Int'] | null),chain?: (Scalars['String'] | null),cpu_usage_us?: (Scalars['Int'] | null),net_usage?: (Scalars['Int'] | null),net_usage_words?: (Scalars['Int'] | null),transaction_id?: (Scalars['String'] | null)}
...
export interface whitelists_aggregate_fieldsGenqlSelection{
    ...
    count?: { __args: {columns?: (whitelists_select_column[] | null), distinct?: (Scalars['Boolean'] | null)} } | boolean | number
...
/** append existing jsonb value of filtered columns with new jsonb value */
export interface whitelists_append_input {actions?: (Scalars['jsonb'] | null),tables?: (Scalars['jsonb'] | null)}
...
export interface whitelists_bool_exp {_and?: (whitelists_bool_exp[] | null),_not?: (whitelists_bool_exp | null),_or?: (whitelists_bool_exp[] | null),actions?: (jsonb_comparison_exp | null),app_id?: (uuid_comparison_exp | null),chain?: (String_comparison_exp | null),contract?: (String_comparison_exp | null),history_ready?: (Boolean_comparison_exp | null),manifest?: (manifests_bool_exp | null),start_block?: (Int_comparison_exp | null),tables?: (jsonb_comparison_exp | null)}


/** delete the field or element with specified path (for JSON arrays, negative integers count from the end) */
export interface whitelists_delete_at_path_input {actions?: (Scalars['String'][] | null),tables?: (Scalars['String'][] | null)}


/** delete the array element with specified index (negative integers count from the end). throws an error if top level container is not an array */
export interface whitelists_delete_elem_input {actions?: (Scalars['Int'] | null),tables?: (Scalars['Int'] | null)}


/** delete key/value pair or string element. key/value pairs are matched based on their key value */
export interface whitelists_delete_key_input {actions?: (Scalars['String'] | null),tables?: (Scalars['String'] | null)}


/** input type for incrementing numeric columns in table "whitelists" */
export interface whitelists_inc_input {start_block?: (Scalars['Int'] | null)}


/** input type for inserting data into table "whitelists" */
export interface whitelists_insert_input {actions?: (Scalars['jsonb'] | null),app_id?: (Scalars['uuid'] | null),chain?: (Scalars['String'] | null),contract?: (Scalars['String'] | null),history_ready?: (Scalars['Boolean'] | null),manifest?: (manifests_obj_rel_insert_input | null),start_block?: (Scalars['Int'] | null),tables?: (Scalars['jsonb'] | null)}
...
export interface whitelists_on_conflict {constraint?: whitelists_constraint,update_columns?: whitelists_update_column[],where?: (whitelists_bool_exp | null)}


/** Ordering options when selecting data from "whitelists". */
export interface whitelists_order_by {actions?: (order_by | null),app_id?: (order_by | null),chain?: (order_by | null),contract?: (order_by | null),history_ready?: (order_by | null),manifest?: (manifests_order_by | null),start_block?: (order_by | null),tables?: (order_by | null)}


/** primary key columns input for table: whitelists */
export interface whitelists_pk_columns_input {app_id?: Scalars['uuid'],chain?: Scalars['String'],contract?: Scalars['String']}


/** prepend existing jsonb value of filtered columns with new jsonb value */
export interface whitelists_prepend_input {actions?: (Scalars['jsonb'] | null),tables?: (Scalars['jsonb'] | null)}


/** input type for updating data in table "whitelists" */
export interface whitelists_set_input {actions?: (Scalars['jsonb'] | null),app_id?: (Scalars['uuid'] | null),chain?: (Scalars['String'] | null),contract?: (Scalars['String'] | null),history_ready?: (Scalars['Boolean'] | null),start_block?: (Scalars['Int'] | null),tables?: (Scalars['jsonb'] | null)}
...
/** Initial value of the column from where the streaming should start */
export interface whitelists_stream_cursor_value_input {actions?: (Scalars['jsonb'] | null),app_id?: (Scalars['uuid'] | null),chain?: (Scalars['String'] | null),contract?: (Scalars['String'] | null),history_ready?: (Scalars['Boolean'] | null),start_block?: (Scalars['Int'] | null),tables?: (Scalars['jsonb'] | null)}
...
export type SubscriptionGenqlSelection = subscription_rootGenqlSelection
    ...
    export const isapi_users_mutation_response = (obj?: { __typename?: any } | null): obj is api_users_mutation_response => {
    ...
    export const isapi_users_stddev_pop_fields = (obj?: { __typename?: any } | null): obj is api_users_stddev_pop_fields => {
    ...
    export const isapi_users_stddev_samp_fields = (obj?: { __typename?: any } | null): obj is api_users_stddev_samp_fields => {
    ...
    export const ismanifests_mutation_response = (obj?: { __typename?: any } | null): obj is manifests_mutation_response => {
    ...
    export const istable_rows_aggregate_fields = (obj?: { __typename?: any } | null): obj is table_rows_aggregate_fields => {
    ...
    export const istable_rows_mutation_response = (obj?: { __typename?: any } | null): obj is table_rows_mutation_response => {
    ...
    export const iswhitelists_aggregate_fields = (obj?: { __typename?: any } | null): obj is whitelists_aggregate_fields => {
    ...
    export const iswhitelists_mutation_response = (obj?: { __typename?: any } | null): obj is whitelists_mutation_response => {
    ...
    export const iswhitelists_stddev_pop_fields = (obj?: { __typename?: any } | null): obj is whitelists_stddev_pop_fields => {
    ...
    export const iswhitelists_stddev_samp_fields = (obj?: { __typename?: any } | null): obj is whitelists_stddev_samp_fields => {
