...
export const getRandomFloat = (): string =>
  parseFloat(`${Math.random() * (56.01 - 51.99) + 51.99}`).toFixed(2)
...
export const dummy_boards = [
  ...
  },
  {
    ...
    time_decreasing: false,
    amend_reason:
      "[NOW I HAVE IT RIGHT 2 !!] It is too much information to handle.",
  },
  {
    author: "andlerz52254",
    type: "amendment_edit",
  ...
  },
  {
    ...
    time_decreasing: false,
    amend_reason:
      "It is too short information to think in a short time... Very short.",
  },
  {
    id: 15,
    type: "amendment_time",
