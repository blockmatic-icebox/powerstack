...
export type AccountsQuery = { accounts: Array<{ account_id: any, username: string, addresses: Array<{ account_id: any, address: string, network: string }> }> };
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    CreateUsername(variables?: CreateUsernameMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<CreateUsernameMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<CreateUsernameMutation>(CreateUsernameDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'CreateUsername', 'mutation');
    },
    Accounts(variables?: AccountsQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<AccountsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<AccountsQuery>(AccountsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'Accounts', 'query');
    }
  };
}
