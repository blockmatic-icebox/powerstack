...
export function Header() {
  ...
  return (
    <div className="min-h-full">
      <div className="bg-white lg:border-b lg:border-indigo-300 lg:border-opacity-25">
              ...
              <div className="px-2 mx-auto max-w-7xl sm:px-4 lg:px-8">
                ...
                <div className="relative flex items-center justify-between h-16 ">
                  ...
                  <div className="flex items-center px-2 lg:px-0">
                    ...
                    <div className="hidden bg-gray-200 lg:ml-10 md:block ">
{/* search */}
                      <div className="flex items-stretch w-full max-w-3xl md:max-w-xs">
                        ...
                        <div className="relative flex text-gray-400 focus-within:text-gray-600">
                          ...
                          <input
                            id="search"
                            className="block w-full py-2 pl-10 pr-3 leading-5 text-gray-900 placeholder-gray-500 border border-transparent rounded-md focus:border-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-indigo-600 sm:text-sm"
                            ...
                            {({ open }) => (
                              <>
                                <div className="relative mt-1">
                                  <Listbox.Button className="relative w-full py-2 pl-3 pr-10 text-left border border-gray-300 rounded-md shadow-sm cursor-default focus:border-white focus:outline-none focus:ring-1 sm:text-sm">
                                  ...
                                  <Transition
                                    ...
                                    leaveTo="opacity-0"
                                  >
                                    <Listbox.Options className="absolute z-10 w-auto py-1 mt-1 overflow-auto text-base bg-white shadow-lg max-h-60 ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm ">
                                      {coins.map((person) => (
                                        <Listbox.Option
                                          key={person.id}
                                          className={({ active }) =>
