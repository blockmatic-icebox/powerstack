                  ...
                  <div className="relative flex items-center justify-between h-16 lg:border-b lg:border-indigo-400 lg:border-opacity-25">
                    ...
                    <div className="flex w-full max-w-lg md:max-w-xs">
                        ...
                        <div className="relative text-gray-400 focus-within:text-gray-600">
                          ...
                          <input
                            id="search"
                            className="block w-full py-2 pl-10 pr-3 leading-5 text-gray-900 placeholder-gray-500 bg-red-200 border border-transparent rounded-md focus:border-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-indigo-600 sm:text-sm"
                        ...
                        {/* coins */}
                        <div className="relative text-gray-400 focus-within:text-gray-600">otro</div>
                    </div>
