...
export type BoardsSelectColumn = 'amendBoard' | 'amendReason' | 'author' | 'budget' | 'deadLine' | 'description' | 'id' | 'kpi' | 'newDate' | 'parentBoard' | 'phase' | 'publishDate' | 'time' | 'timeDecreasing' | 'title' | 'type'
...
export type BoardsUpdateColumn = 'amendBoard' | 'amendReason' | 'author' | 'budget' | 'deadLine' | 'description' | 'id' | 'kpi' | 'newDate' | 'parentBoard' | 'phase' | 'publishDate' | 'time' | 'timeDecreasing' | 'title' | 'type'
...
export type CommentsSelectColumn = 'author' | 'boardId' | 'content' | 'createdAt' | 'id' | 'replyId' | 'updatedAt' | 'upvote'
...
export type CommentsUpdateColumn = 'author' | 'boardId' | 'content' | 'createdAt' | 'id' | 'replyId' | 'updatedAt' | 'upvote'
...
export type UserActivityConstraint = 'activity_pkey' | 'activity_user_id_key' | 'user_activity_activity_id_key' | 'user_activity_activity_type_key'
...
export interface BoardPhaseGenqlSelection{
    /** An array relationship */
    boards?: (BoardsGenqlSelection & { __args?: {
    ...
    /** An aggregate relationship */
    boardsAggregate?: (BoardsAggregateGenqlSelection & { __args?: {
    /** distinct select on columns */
    distinctOn?: (BoardsSelectColumn[] | null), 
    /** limit the number of rows returned */
    limit?: (Scalars['Int'] | null), 
...
export interface BoardPhaseAggregateFieldsGenqlSelection{
    count?: { __args: {columns?: (BoardPhaseSelectColumn[] | null), distinct?: (Scalars['Boolean'] | null)} } | boolean | number
...
export interface BoardPhaseBoolExp {_and?: (BoardPhaseBoolExp[] | null),_not?: (BoardPhaseBoolExp | null),_or?: (BoardPhaseBoolExp[] | null),boards?: (BoardsBoolExp | null),boardsAggregate?: (BoardsAggregateBoolExp | null),value?: (StringComparisonExp | null)}


/** Boolean expression to compare columns of type "BoardPhaseEnum". All fields are combined with logical 'AND'. */
export interface BoardPhaseEnumComparisonExp {_eq?: (BoardPhaseEnum | null),_in?: (BoardPhaseEnum[] | null),_isNull?: (Scalars['Boolean'] | null),_neq?: (BoardPhaseEnum | null),_nin?: (BoardPhaseEnum[] | null)}


/** input type for inserting data into table "board_phase" */
export interface BoardPhaseInsertInput {boards?: (BoardsArrRelInsertInput | null),value?: (Scalars['String'] | null)}
...
export interface BoardPhaseObjRelInsertInput {data?: BoardPhaseInsertInput,
/** upsert condition */
onConflict?: (BoardPhaseOnConflict | null)}


/** on_conflict condition type for table "board_phase" */
export interface BoardPhaseOnConflict {constraint?: BoardPhaseConstraint,updateColumns?: BoardPhaseUpdateColumn[],where?: (BoardPhaseBoolExp | null)}


/** Ordering options when selecting data from "board_phase". */
export interface BoardPhaseOrderBy {boardsAggregate?: (BoardsAggregateOrderBy | null),value?: (OrderBy | null)}


/** primary key columns input for table: board_phase */
export interface BoardPhasePkColumnsInput {value?: Scalars['String']}


/** input type for updating data in table "board_phase" */
export interface BoardPhaseSetInput {value?: (Scalars['String'] | null)}
...
export interface BoardPhaseStreamCursorValueInput {value?: (Scalars['String'] | null)}
...
export interface BoardTypeAggregateFieldsGenqlSelection{
    count?: { __args: {columns?: (BoardTypeSelectColumn[] | null), distinct?: (Scalars['Boolean'] | null)} } | boolean | number
...
export interface BoardTypeBoolExp {_and?: (BoardTypeBoolExp[] | null),_not?: (BoardTypeBoolExp | null),_or?: (BoardTypeBoolExp[] | null),boards?: (BoardsBoolExp | null),boardsAggregate?: (BoardsAggregateBoolExp | null),value?: (StringComparisonExp | null)}


/** Boolean expression to compare columns of type "BoardTypeEnum". All fields are combined with logical 'AND'. */
export interface BoardTypeEnumComparisonExp {_eq?: (BoardTypeEnum | null),_in?: (BoardTypeEnum[] | null),_isNull?: (Scalars['Boolean'] | null),_neq?: (BoardTypeEnum | null),_nin?: (BoardTypeEnum[] | null)}


/** input type for inserting data into table "board_type" */
export interface BoardTypeInsertInput {boards?: (BoardsArrRelInsertInput | null),value?: (Scalars['String'] | null)}
...
export interface BoardTypeObjRelInsertInput {data?: BoardTypeInsertInput,
/** upsert condition */
onConflict?: (BoardTypeOnConflict | null)}


/** on_conflict condition type for table "board_type" */
export interface BoardTypeOnConflict {constraint?: BoardTypeConstraint,updateColumns?: BoardTypeUpdateColumn[],where?: (BoardTypeBoolExp | null)}


/** Ordering options when selecting data from "board_type". */
export interface BoardTypeOrderBy {boardsAggregate?: (BoardsAggregateOrderBy | null),value?: (OrderBy | null)}


/** primary key columns input for table: board_type */
export interface BoardTypePkColumnsInput {value?: Scalars['String']}


/** input type for updating data in table "board_type" */
export interface BoardTypeSetInput {value?: (Scalars['String'] | null)}
...
/** Initial value of the column from where the streaming should start */
export interface BoardTypeStreamCursorValueInput {value?: (Scalars['String'] | null)}
...
export interface BoardsGenqlSelection{
    ...
    /** An aggregate relationship */
    childBoardsRelAggregate?: (BoardsAggregateGenqlSelection & { __args?: {
    /** distinct select on columns */
    distinctOn?: (BoardsSelectColumn[] | null), 
    /** limit the number of rows returned */
    limit?: (Scalars['Int'] | null), 
    ...
    where?: (BoardsBoolExp | null)} })
    /** An array relationship */
    child_boards_rel?: (BoardsGenqlSelection & { __args?: {
    /** distinct select on columns */
    distinctOn?: (BoardsSelectColumn[] | null), 
    /** limit the number of rows returned */
    limit?: (Scalars['Int'] | null), 
    ...
    /** An aggregate relationship */
    commentsAggregate?: (CommentsAggregateGenqlSelection & { __args?: {
    /** distinct select on columns */
    distinctOn?: (CommentsSelectColumn[] | null), 
    /** limit the number of rows returned */
    limit?: (Scalars['Int'] | null), 
...
export interface BoardsAggregateBoolExp {bool_and?: (boardsAggregateBoolExpBool_and | null),bool_or?: (boardsAggregateBoolExpBool_or | null),count?: (boardsAggregateBoolExpCount | null)}


/** aggregate fields of "boards" */
export interface BoardsAggregateFieldsGenqlSelection{
    count?: { __args: {columns?: (BoardsSelectColumn[] | null), distinct?: (Scalars['Boolean'] | null)} } | boolean | number
...
export interface BoardsAggregateOrderBy {count?: (OrderBy | null),max?: (BoardsMaxOrderBy | null),min?: (BoardsMinOrderBy | null)}


/** input type for inserting array relation for remote table "boards" */
export interface BoardsArrRelInsertInput {data?: BoardsInsertInput[],
/** upsert condition */
...
export interface BoardsBoolExp {_and?: (BoardsBoolExp[] | null),_not?: (BoardsBoolExp | null),_or?: (BoardsBoolExp[] | null),amendBoard?: (UuidComparisonExp | null),amendReason?: (StringComparisonExp | null),author?: (StringComparisonExp | null),board_phase?: (BoardPhaseBoolExp | null),board_type?: (BoardTypeBoolExp | null),boards?: (BoardsBoolExp | null),boardsAggregate?: (BoardsAggregateBoolExp | null),budget?: (StringComparisonExp | null),child_boards_rel?: (BoardsBoolExp | null),child_boards_relAggregate?: (BoardsAggregateBoolExp | null),comments?: (CommentsBoolExp | null),commentsAggregate?: (CommentsAggregateBoolExp | null),deadLine?: (StringComparisonExp | null),description?: (StringComparisonExp | null),id?: (UuidComparisonExp | null),kpi?: (StringComparisonExp | null),newDate?: (TimestamptzComparisonExp | null),parentBoard?: (UuidComparisonExp | null),parent_amend_rel?: (BoardsBoolExp | null),parent_board_rel?: (BoardsBoolExp | null),phase?: (BoardPhaseEnumComparisonExp | null),publishDate?: (TimestamptzComparisonExp | null),time?: (TimestamptzComparisonExp | null),timeDecreasing?: (BooleanComparisonExp | null),title?: (StringComparisonExp | null),type?: (BoardTypeEnumComparisonExp | null),user_activity?: (UserActivityBoolExp | null)}


/** input type for inserting data into table "boards" */
export interface BoardsInsertInput {amendBoard?: (Scalars['uuid'] | null),amendReason?: (Scalars['String'] | null),author?: (Scalars['String'] | null),board_phase?: (BoardPhaseObjRelInsertInput | null),board_type?: (BoardTypeObjRelInsertInput | null),boards?: (BoardsArrRelInsertInput | null),budget?: (Scalars['String'] | null),child_boards_rel?: (BoardsArrRelInsertInput | null),comments?: (CommentsArrRelInsertInput | null),deadLine?: (Scalars['String'] | null),description?: (Scalars['String'] | null),id?: (Scalars['uuid'] | null),kpi?: (Scalars['String'] | null),newDate?: (Scalars['timestamptz'] | null),parentBoard?: (Scalars['uuid'] | null),parent_amend_rel?: (BoardsObjRelInsertInput | null),parent_board_rel?: (BoardsObjRelInsertInput | null),phase?: (BoardPhaseEnum | null),publishDate?: (Scalars['timestamptz'] | null),time?: (Scalars['timestamptz'] | null),timeDecreasing?: (Scalars['Boolean'] | null),title?: (Scalars['String'] | null),type?: (BoardTypeEnum | null),user_activity?: (UserActivityObjRelInsertInput | null)}
...
export interface BoardsMaxOrderBy {amendBoard?: (OrderBy | null),amendReason?: (OrderBy | null),author?: (OrderBy | null),budget?: (OrderBy | null),deadLine?: (OrderBy | null),description?: (OrderBy | null),id?: (OrderBy | null),kpi?: (OrderBy | null),newDate?: (OrderBy | null),parentBoard?: (OrderBy | null),publishDate?: (OrderBy | null),time?: (OrderBy | null),title?: (OrderBy | null)}
...
export interface BoardsMinOrderBy {amendBoard?: (OrderBy | null),amendReason?: (OrderBy | null),author?: (OrderBy | null),budget?: (OrderBy | null),deadLine?: (OrderBy | null),description?: (OrderBy | null),id?: (OrderBy | null),kpi?: (OrderBy | null),newDate?: (OrderBy | null),parentBoard?: (OrderBy | null),publishDate?: (OrderBy | null),time?: (OrderBy | null),title?: (OrderBy | null)}
...
export interface BoardsObjRelInsertInput {data?: BoardsInsertInput,
/** upsert condition */
onConflict?: (BoardsOnConflict | null)}


/** on_conflict condition type for table "boards" */
export interface BoardsOnConflict {constraint?: BoardsConstraint,updateColumns?: BoardsUpdateColumn[],where?: (BoardsBoolExp | null)}


/** Ordering options when selecting data from "boards". */
export interface BoardsOrderBy {amendBoard?: (OrderBy | null),amendReason?: (OrderBy | null),author?: (OrderBy | null),board_phase?: (BoardPhaseOrderBy | null),board_type?: (BoardTypeOrderBy | null),boardsAggregate?: (BoardsAggregateOrderBy | null),budget?: (OrderBy | null),child_boards_relAggregate?: (BoardsAggregateOrderBy | null),commentsAggregate?: (CommentsAggregateOrderBy | null),deadLine?: (OrderBy | null),description?: (OrderBy | null),id?: (OrderBy | null),kpi?: (OrderBy | null),newDate?: (OrderBy | null),parentBoard?: (OrderBy | null),parent_amend_rel?: (BoardsOrderBy | null),parent_board_rel?: (BoardsOrderBy | null),phase?: (OrderBy | null),publishDate?: (OrderBy | null),time?: (OrderBy | null),timeDecreasing?: (OrderBy | null),title?: (OrderBy | null),type?: (OrderBy | null),user_activity?: (UserActivityOrderBy | null)}


/** primary key columns input for table: boards */
export interface BoardsPkColumnsInput {id?: Scalars['uuid']}


/** input type for updating data in table "boards" */
export interface BoardsSetInput {amendBoard?: (Scalars['uuid'] | null),amendReason?: (Scalars['String'] | null),author?: (Scalars['String'] | null),budget?: (Scalars['String'] | null),deadLine?: (Scalars['String'] | null),description?: (Scalars['String'] | null),id?: (Scalars['uuid'] | null),kpi?: (Scalars['String'] | null),newDate?: (Scalars['timestamptz'] | null),parentBoard?: (Scalars['uuid'] | null),phase?: (BoardPhaseEnum | null),publishDate?: (Scalars['timestamptz'] | null),time?: (Scalars['timestamptz'] | null),timeDecreasing?: (Scalars['Boolean'] | null),title?: (Scalars['String'] | null),type?: (BoardTypeEnum | null)}
...
/** Initial value of the column from where the streaming should start */
export interface BoardsStreamCursorValueInput {amendBoard?: (Scalars['uuid'] | null),amendReason?: (Scalars['String'] | null),author?: (Scalars['String'] | null),budget?: (Scalars['String'] | null),deadLine?: (Scalars['String'] | null),description?: (Scalars['String'] | null),id?: (Scalars['uuid'] | null),kpi?: (Scalars['String'] | null),newDate?: (Scalars['timestamptz'] | null),parentBoard?: (Scalars['uuid'] | null),phase?: (BoardPhaseEnum | null),publishDate?: (Scalars['timestamptz'] | null),time?: (Scalars['timestamptz'] | null),timeDecreasing?: (Scalars['Boolean'] | null),title?: (Scalars['String'] | null),type?: (BoardTypeEnum | null)}
...
export interface CommentsAggregateBoolExp {count?: (commentsAggregateBoolExpCount | null)}


/** aggregate fields of "comments" */
export interface CommentsAggregateFieldsGenqlSelection{
    avg?: CommentsAvgFieldsGenqlSelection
    count?: { __args: {columns?: (CommentsSelectColumn[] | null), distinct?: (Scalars['Boolean'] | null)} } | boolean | number
...
export interface CommentsAggregateOrderBy {avg?: (CommentsAvgOrderBy | null),count?: (OrderBy | null),max?: (CommentsMaxOrderBy | null),min?: (CommentsMinOrderBy | null),stddev?: (CommentsStddevOrderBy | null),stddevPop?: (CommentsStddevPopOrderBy | null),stddevSamp?: (CommentsStddevSampOrderBy | null),sum?: (CommentsSumOrderBy | null),varPop?: (CommentsVarPopOrderBy | null),varSamp?: (CommentsVarSampOrderBy | null),variance?: (CommentsVarianceOrderBy | null)}


/** input type for inserting array relation for remote table "comments" */
export interface CommentsArrRelInsertInput {data?: CommentsInsertInput[],
/** upsert condition */
...
export interface CommentsAvgOrderBy {upvote?: (OrderBy | null)}


/** Boolean expression to filter rows from the table "comments". All fields are combined with a logical 'AND'. */
export interface CommentsBoolExp {_and?: (CommentsBoolExp[] | null),_not?: (CommentsBoolExp | null),_or?: (CommentsBoolExp[] | null),author?: (UuidComparisonExp | null),board?: (BoardsBoolExp | null),boardId?: (UuidComparisonExp | null),content?: (StringComparisonExp | null),createdAt?: (TimestamptzComparisonExp | null),id?: (UuidComparisonExp | null),replyId?: (UuidComparisonExp | null),updatedAt?: (TimestamptzComparisonExp | null),upvote?: (IntComparisonExp | null),user?: (UserBoolExp | null)}


/** input type for incrementing numeric columns in table "comments" */
export interface CommentsIncInput {upvote?: (Scalars['Int'] | null)}


/** input type for inserting data into table "comments" */
export interface CommentsInsertInput {author?: (Scalars['uuid'] | null),board?: (BoardsObjRelInsertInput | null),boardId?: (Scalars['uuid'] | null),content?: (Scalars['String'] | null),createdAt?: (Scalars['timestamptz'] | null),id?: (Scalars['uuid'] | null),replyId?: (Scalars['uuid'] | null),updatedAt?: (Scalars['timestamptz'] | null),upvote?: (Scalars['Int'] | null),user?: (UserObjRelInsertInput | null)}
...
export interface CommentsMaxOrderBy {author?: (OrderBy | null),boardId?: (OrderBy | null),content?: (OrderBy | null),createdAt?: (OrderBy | null),id?: (OrderBy | null),replyId?: (OrderBy | null),updatedAt?: (OrderBy | null),upvote?: (OrderBy | null)}
...
export interface CommentsMinOrderBy {author?: (OrderBy | null),boardId?: (OrderBy | null),content?: (OrderBy | null),createdAt?: (OrderBy | null),id?: (OrderBy | null),replyId?: (OrderBy | null),updatedAt?: (OrderBy | null),upvote?: (OrderBy | null)}
...
export interface CommentsOnConflict {constraint?: CommentsConstraint,updateColumns?: CommentsUpdateColumn[],where?: (CommentsBoolExp | null)}


/** Ordering options when selecting data from "comments". */
export interface CommentsOrderBy {author?: (OrderBy | null),board?: (BoardsOrderBy | null),boardId?: (OrderBy | null),content?: (OrderBy | null),createdAt?: (OrderBy | null),id?: (OrderBy | null),replyId?: (OrderBy | null),updatedAt?: (OrderBy | null),upvote?: (OrderBy | null),user?: (UserOrderBy | null)}


/** primary key columns input for table: comments */
export interface CommentsPkColumnsInput {id?: Scalars['uuid']}


/** input type for updating data in table "comments" */
export interface CommentsSetInput {author?: (Scalars['uuid'] | null),boardId?: (Scalars['uuid'] | null),content?: (Scalars['String'] | null),createdAt?: (Scalars['timestamptz'] | null),id?: (Scalars['uuid'] | null),replyId?: (Scalars['uuid'] | null),updatedAt?: (Scalars['timestamptz'] | null),upvote?: (Scalars['Int'] | null)}
...
export interface CommentsStddevOrderBy {upvote?: (OrderBy | null)}
...
export interface CommentsStddevPopOrderBy {upvote?: (OrderBy | null)}
...
export interface CommentsStddevSampOrderBy {upvote?: (OrderBy | null)}
...
/** Initial value of the column from where the streaming should start */
export interface CommentsStreamCursorValueInput {author?: (Scalars['uuid'] | null),boardId?: (Scalars['uuid'] | null),content?: (Scalars['String'] | null),createdAt?: (Scalars['timestamptz'] | null),id?: (Scalars['uuid'] | null),replyId?: (Scalars['uuid'] | null),updatedAt?: (Scalars['timestamptz'] | null),upvote?: (Scalars['Int'] | null)}
...
export interface CommentsSumOrderBy {upvote?: (OrderBy | null)}
...
export interface CommentsVarPopOrderBy {upvote?: (OrderBy | null)}
...
export interface CommentsVarSampOrderBy {upvote?: (OrderBy | null)}
...
export interface CommentsVarianceOrderBy {upvote?: (OrderBy | null)}
...
export interface UserActivityAggregateFieldsGenqlSelection{
    count?: { __args: {columns?: (UserActivitySelectColumn[] | null), distinct?: (Scalars['Boolean'] | null)} } | boolean | number
...
export interface UserActivityBoolExp {_and?: (UserActivityBoolExp[] | null),_not?: (UserActivityBoolExp | null),_or?: (UserActivityBoolExp[] | null),activityId?: (UuidComparisonExp | null),activityType?: (UserActivityTypeEnumComparisonExp | null),board?: (BoardsBoolExp | null),id?: (UuidComparisonExp | null),user?: (UserBoolExp | null),userId?: (UuidComparisonExp | null),user_activity_type?: (UserActivityTypeBoolExp | null)}


/** input type for inserting data into table "user_activity" */
export interface UserActivityInsertInput {activityId?: (Scalars['uuid'] | null),activityType?: (UserActivityTypeEnum | null),board?: (BoardsObjRelInsertInput | null),id?: (Scalars['uuid'] | null),user?: (UserObjRelInsertInput | null),userId?: (Scalars['uuid'] | null),user_activity_type?: (UserActivityTypeObjRelInsertInput | null)}
...
export interface UserActivityObjRelInsertInput {data?: UserActivityInsertInput,
/** upsert condition */
onConflict?: (UserActivityOnConflict | null)}


/** on_conflict condition type for table "user_activity" */
export interface UserActivityOnConflict {constraint?: UserActivityConstraint,updateColumns?: UserActivityUpdateColumn[],where?: (UserActivityBoolExp | null)}


/** Ordering options when selecting data from "user_activity". */
export interface UserActivityOrderBy {activityId?: (OrderBy | null),activityType?: (OrderBy | null),board?: (BoardsOrderBy | null),id?: (OrderBy | null),user?: (UserOrderBy | null),userId?: (OrderBy | null),user_activity_type?: (UserActivityTypeOrderBy | null)}


/** primary key columns input for table: user_activity */
export interface UserActivityPkColumnsInput {id?: Scalars['uuid']}


/** input type for updating data in table "user_activity" */
export interface UserActivitySetInput {activityId?: (Scalars['uuid'] | null),activityType?: (UserActivityTypeEnum | null),id?: (Scalars['uuid'] | null),userId?: (Scalars['uuid'] | null)}
...
/** Initial value of the column from where the streaming should start */
export interface UserActivityStreamCursorValueInput {activityId?: (Scalars['uuid'] | null),activityType?: (UserActivityTypeEnum | null),id?: (Scalars['uuid'] | null),userId?: (Scalars['uuid'] | null)}
...
export interface UserActivityTypeAggregateFieldsGenqlSelection{
    count?: { __args: {columns?: (UserActivityTypeSelectColumn[] | null), distinct?: (Scalars['Boolean'] | null)} } | boolean | number
...
export interface UserActivityTypeBoolExp {_and?: (UserActivityTypeBoolExp[] | null),_not?: (UserActivityTypeBoolExp | null),_or?: (UserActivityTypeBoolExp[] | null),user_activity?: (UserActivityBoolExp | null),value?: (StringComparisonExp | null)}


/** Boolean expression to compare columns of type "UserActivityTypeEnum". All fields are combined with logical 'AND'. */
export interface UserActivityTypeEnumComparisonExp {_eq?: (UserActivityTypeEnum | null),_in?: (UserActivityTypeEnum[] | null),_isNull?: (Scalars['Boolean'] | null),_neq?: (UserActivityTypeEnum | null),_nin?: (UserActivityTypeEnum[] | null)}


/** input type for inserting data into table "user_activity_type" */
export interface UserActivityTypeInsertInput {user_activity?: (UserActivityObjRelInsertInput | null),value?: (Scalars['String'] | null)}
...
export interface UserActivityTypeObjRelInsertInput {data?: UserActivityTypeInsertInput,
/** upsert condition */
onConflict?: (UserActivityTypeOnConflict | null)}


/** on_conflict condition type for table "user_activity_type" */
export interface UserActivityTypeOnConflict {constraint?: UserActivityTypeConstraint,updateColumns?: UserActivityTypeUpdateColumn[],where?: (UserActivityTypeBoolExp | null)}


/** Ordering options when selecting data from "user_activity_type". */
export interface UserActivityTypeOrderBy {user_activity?: (UserActivityOrderBy | null),value?: (OrderBy | null)}


/** primary key columns input for table: user_activity_type */
export interface UserActivityTypePkColumnsInput {value?: Scalars['String']}


/** input type for updating data in table "user_activity_type" */
export interface UserActivityTypeSetInput {value?: (Scalars['String'] | null)}
...
/** Initial value of the column from where the streaming should start */
export interface UserActivityTypeStreamCursorValueInput {value?: (Scalars['String'] | null)}
...
export interface UserAppendInput {preferences?: (Scalars['jsonb'] | null)}


/** Boolean expression to filter rows from the table "user". All fields are combined with a logical 'AND'. */
export interface UserBoolExp {_and?: (UserBoolExp[] | null),_not?: (UserBoolExp | null),_or?: (UserBoolExp[] | null),account?: (StringComparisonExp | null),address?: (StringComparisonExp | null),comments?: (CommentsBoolExp | null),commentsAggregate?: (CommentsAggregateBoolExp | null),id?: (UuidComparisonExp | null),preferences?: (JsonbComparisonExp | null),user_activity?: (UserActivityBoolExp | null)}


/** delete the field or element with specified path (for JSON arrays, negative integers count from the end) */
export interface UserDeleteAtPathInput {preferences?: (Scalars['String'][] | null)}


/** delete the array element with specified index (negative integers count from the end). throws an error if top level container is not an array */
export interface UserDeleteElemInput {preferences?: (Scalars['Int'] | null)}


/** delete key/value pair or string element. key/value pairs are matched based on their key value */
export interface UserDeleteKeyInput {preferences?: (Scalars['String'] | null)}


/** input type for inserting data into table "user" */
export interface UserInsertInput {account?: (Scalars['String'] | null),address?: (Scalars['String'] | null),comments?: (CommentsArrRelInsertInput | null),id?: (Scalars['uuid'] | null),preferences?: (Scalars['jsonb'] | null),user_activity?: (UserActivityObjRelInsertInput | null)}
...
export interface UserOrderBy {account?: (OrderBy | null),address?: (OrderBy | null),commentsAggregate?: (CommentsAggregateOrderBy | null),id?: (OrderBy | null),preferences?: (OrderBy | null),user_activity?: (UserActivityOrderBy | null)}


/** primary key columns input for table: user */
export interface UserPkColumnsInput {account?: Scalars['String']}


/** prepend existing jsonb value of filtered columns with new jsonb value */
export interface UserPrependInput {preferences?: (Scalars['jsonb'] | null)}


/** input type for updating data in table "user" */
export interface UserSetInput {account?: (Scalars['String'] | null),address?: (Scalars['String'] | null),id?: (Scalars['uuid'] | null),preferences?: (Scalars['jsonb'] | null)}
...
/** Initial value of the column from where the streaming should start */
export interface UserStreamCursorValueInput {account?: (Scalars['String'] | null),address?: (Scalars['String'] | null),id?: (Scalars['uuid'] | null),preferences?: (Scalars['jsonb'] | null)}
...
export interface boardsAggregateBoolExpBool_and {arguments?: BoardsSelectColumnBoardsAggregateBoolExpBool_andArgumentsColumns,distinct?: (Scalars['Boolean'] | null),filter?: (BoardsBoolExp | null),predicate?: BooleanComparisonExp}

export interface boardsAggregateBoolExpBool_or {arguments?: BoardsSelectColumnBoardsAggregateBoolExpBool_orArgumentsColumns,distinct?: (Scalars['Boolean'] | null),filter?: (BoardsBoolExp | null),predicate?: BooleanComparisonExp}

export interface boardsAggregateBoolExpCount {arguments?: (BoardsSelectColumn[] | null),distinct?: (Scalars['Boolean'] | null),filter?: (BoardsBoolExp | null),predicate?: IntComparisonExp}

export interface commentsAggregateBoolExpCount {arguments?: (CommentsSelectColumn[] | null),distinct?: (Scalars['Boolean'] | null),filter?: (CommentsBoolExp | null),predicate?: IntComparisonExp}


/** mutation root */
export interface mutation_rootGenqlSelection{
    /** delete data from the table: "board_phase" */
    deleteBoardPhase?: (BoardPhaseMutationResponseGenqlSelection & { __args: {
    /** filter the rows which have to be deleted */
    where: BoardPhaseBoolExp} })
    /** delete single row from the table: "board_phase" */
    deleteBoardPhaseByPk?: (BoardPhaseGenqlSelection & { __args: {value: Scalars['String']} })
    /** delete data from the table: "board_type" */
    deleteBoardType?: (BoardTypeMutationResponseGenqlSelection & { __args: {
    /** filter the rows which have to be deleted */
    where: BoardTypeBoolExp} })
    /** delete single row from the table: "board_type" */
    deleteBoardTypeByPk?: (BoardTypeGenqlSelection & { __args: {value: Scalars['String']} })
    /** delete data from the table: "boards" */
    deleteBoards?: (BoardsMutationResponseGenqlSelection & { __args: {
    /** filter the rows which have to be deleted */
    where: BoardsBoolExp} })
    /** delete single row from the table: "boards" */
    deleteBoardsByPk?: (BoardsGenqlSelection & { __args: {id: Scalars['uuid']} })
    /** delete data from the table: "comments" */
    deleteComments?: (CommentsMutationResponseGenqlSelection & { __args: {
    /** filter the rows which have to be deleted */
    where: CommentsBoolExp} })
    /** delete single row from the table: "comments" */
    deleteCommentsByPk?: (CommentsGenqlSelection & { __args: {id: Scalars['uuid']} })
    /** delete data from the table: "user" */
    deleteUser?: (UserMutationResponseGenqlSelection & { __args: {
    /** filter the rows which have to be deleted */
    where: UserBoolExp} })
    /** delete data from the table: "user_activity" */
    deleteUserActivity?: (UserActivityMutationResponseGenqlSelection & { __args: {
    /** filter the rows which have to be deleted */
    where: UserActivityBoolExp} })
    /** delete single row from the table: "user_activity" */
    deleteUserActivityByPk?: (UserActivityGenqlSelection & { __args: {id: Scalars['uuid']} })
    /** delete data from the table: "user_activity_type" */
    deleteUserActivityType?: (UserActivityTypeMutationResponseGenqlSelection & { __args: {
    /** filter the rows which have to be deleted */
    where: UserActivityTypeBoolExp} })
    /** delete single row from the table: "user_activity_type" */
    deleteUserActivityTypeByPk?: (UserActivityTypeGenqlSelection & { __args: {value: Scalars['String']} })
    /** delete single row from the table: "user" */
    deleteUserByPk?: (UserGenqlSelection & { __args: {account: Scalars['String']} })
    /** insert data into the table: "board_phase" */
    insertBoardPhase?: (BoardPhaseMutationResponseGenqlSelection & { __args: {
    /** the rows to be inserted */
    objects: BoardPhaseInsertInput[], 
    /** upsert condition */
    onConflict?: (BoardPhaseOnConflict | null)} })
    /** insert a single row into the table: "board_phase" */
    insertBoardPhaseOne?: (BoardPhaseGenqlSelection & { __args: {
    /** the row to be inserted */
    object: BoardPhaseInsertInput, 
    /** upsert condition */
    onConflict?: (BoardPhaseOnConflict | null)} })
    /** insert data into the table: "board_type" */
    insertBoardType?: (BoardTypeMutationResponseGenqlSelection & { __args: {
    /** the rows to be inserted */
    objects: BoardTypeInsertInput[], 
    /** upsert condition */
    onConflict?: (BoardTypeOnConflict | null)} })
    /** insert a single row into the table: "board_type" */
    insertBoardTypeOne?: (BoardTypeGenqlSelection & { __args: {
    /** the row to be inserted */
    object: BoardTypeInsertInput, 
    /** upsert condition */
    onConflict?: (BoardTypeOnConflict | null)} })
    /** insert data into the table: "boards" */
    insertBoards?: (BoardsMutationResponseGenqlSelection & { __args: {
    /** the rows to be inserted */
    objects: BoardsInsertInput[], 
    /** upsert condition */
    onConflict?: (BoardsOnConflict | null)} })
    /** insert a single row into the table: "boards" */
    insertBoardsOne?: (BoardsGenqlSelection & { __args: {
    /** the row to be inserted */
    object: BoardsInsertInput, 
    /** upsert condition */
    onConflict?: (BoardsOnConflict | null)} })
    /** insert data into the table: "comments" */
    insertComments?: (CommentsMutationResponseGenqlSelection & { __args: {
    /** the rows to be inserted */
    objects: CommentsInsertInput[], 
    /** upsert condition */
    onConflict?: (CommentsOnConflict | null)} })
    /** insert a single row into the table: "comments" */
    insertCommentsOne?: (CommentsGenqlSelection & { __args: {
    /** the row to be inserted */
    ...
    onConflict?: (UserOnConflict | null)} })
    /** insert data into the table: "user_activity" */
    insertUserActivity?: (UserActivityMutationResponseGenqlSelection & { __args: {
    /** the rows to be inserted */
    objects: UserActivityInsertInput[], 
    /** upsert condition */
    onConflict?: (UserActivityOnConflict | null)} })
    /** insert a single row into the table: "user_activity" */
    insertUserActivityOne?: (UserActivityGenqlSelection & { __args: {
    /** the row to be inserted */
    object: UserActivityInsertInput, 
    /** upsert condition */
    onConflict?: (UserActivityOnConflict | null)} })
    /** insert data into the table: "user_activity_type" */
    insertUserActivityType?: (UserActivityTypeMutationResponseGenqlSelection & { __args: {
    /** the rows to be inserted */
    objects: UserActivityTypeInsertInput[], 
    /** upsert condition */
    onConflict?: (UserActivityTypeOnConflict | null)} })
    /** insert a single row into the table: "user_activity_type" */
    insertUserActivityTypeOne?: (UserActivityTypeGenqlSelection & { __args: {
    /** the row to be inserted */
    ...
    onConflict?: (UserOnConflict | null)} })
    /** update data of the table: "board_phase" */
    updateBoardPhase?: (BoardPhaseMutationResponseGenqlSelection & { __args: {
    /** sets the columns of the filtered rows to the given values */
    _set?: (BoardPhaseSetInput | null), 
    /** filter the rows which have to be updated */
    where: BoardPhaseBoolExp} })
    /** update single row of the table: "board_phase" */
    updateBoardPhaseByPk?: (BoardPhaseGenqlSelection & { __args: {
    /** sets the columns of the filtered rows to the given values */
    _set?: (BoardPhaseSetInput | null), pkColumns: BoardPhasePkColumnsInput} })
    /** update multiples rows of table: "board_phase" */
    updateBoardPhaseMany?: (BoardPhaseMutationResponseGenqlSelection & { __args: {
    /** updates to execute, in order */
    updates: BoardPhaseUpdates[]} })
    /** update data of the table: "board_type" */
    updateBoardType?: (BoardTypeMutationResponseGenqlSelection & { __args: {
    /** sets the columns of the filtered rows to the given values */
    _set?: (BoardTypeSetInput | null), 
    /** filter the rows which have to be updated */
    where: BoardTypeBoolExp} })
    /** update single row of the table: "board_type" */
    updateBoardTypeByPk?: (BoardTypeGenqlSelection & { __args: {
    /** sets the columns of the filtered rows to the given values */
    _set?: (BoardTypeSetInput | null), pkColumns: BoardTypePkColumnsInput} })
    /** update multiples rows of table: "board_type" */
    updateBoardTypeMany?: (BoardTypeMutationResponseGenqlSelection & { __args: {
    /** updates to execute, in order */
    updates: BoardTypeUpdates[]} })
    /** update data of the table: "boards" */
    updateBoards?: (BoardsMutationResponseGenqlSelection & { __args: {
    /** sets the columns of the filtered rows to the given values */
    _set?: (BoardsSetInput | null), 
    /** filter the rows which have to be updated */
    where: BoardsBoolExp} })
    /** update single row of the table: "boards" */
    updateBoardsByPk?: (BoardsGenqlSelection & { __args: {
    /** sets the columns of the filtered rows to the given values */
    _set?: (BoardsSetInput | null), pkColumns: BoardsPkColumnsInput} })
    /** update multiples rows of table: "boards" */
    updateBoardsMany?: (BoardsMutationResponseGenqlSelection & { __args: {
    /** updates to execute, in order */
    updates: BoardsUpdates[]} })
    /** update data of the table: "comments" */
    updateComments?: (CommentsMutationResponseGenqlSelection & { __args: {
    /** increments the numeric columns with given value of the filtered values */
    _inc?: (CommentsIncInput | null), 
    /** sets the columns of the filtered rows to the given values */
    _set?: (CommentsSetInput | null), 
    ...
    where: CommentsBoolExp} })
    /** update single row of the table: "comments" */
    updateCommentsByPk?: (CommentsGenqlSelection & { __args: {
    /** increments the numeric columns with given value of the filtered values */
    _inc?: (CommentsIncInput | null), 
    /** sets the columns of the filtered rows to the given values */
    _set?: (CommentsSetInput | null), pkColumns: CommentsPkColumnsInput} })
    /** update multiples rows of table: "comments" */
    updateCommentsMany?: (CommentsMutationResponseGenqlSelection & { __args: {
    /** updates to execute, in order */
    ...
    where: UserBoolExp} })
    /** update data of the table: "user_activity" */
    updateUserActivity?: (UserActivityMutationResponseGenqlSelection & { __args: {
    /** sets the columns of the filtered rows to the given values */
    _set?: (UserActivitySetInput | null), 
    /** filter the rows which have to be updated */
    where: UserActivityBoolExp} })
    /** update single row of the table: "user_activity" */
    updateUserActivityByPk?: (UserActivityGenqlSelection & { __args: {
    /** sets the columns of the filtered rows to the given values */
    _set?: (UserActivitySetInput | null), pkColumns: UserActivityPkColumnsInput} })
    /** update multiples rows of table: "user_activity" */
    updateUserActivityMany?: (UserActivityMutationResponseGenqlSelection & { __args: {
    /** updates to execute, in order */
    updates: UserActivityUpdates[]} })
    /** update data of the table: "user_activity_type" */
    updateUserActivityType?: (UserActivityTypeMutationResponseGenqlSelection & { __args: {
    /** sets the columns of the filtered rows to the given values */
    _set?: (UserActivityTypeSetInput | null), 
    /** filter the rows which have to be updated */
    where: UserActivityTypeBoolExp} })
    /** update single row of the table: "user_activity_type" */
    updateUserActivityTypeByPk?: (UserActivityTypeGenqlSelection & { __args: {
    /** sets the columns of the filtered rows to the given values */
    _set?: (UserActivityTypeSetInput | null), pkColumns: UserActivityTypePkColumnsInput} })
    /** update multiples rows of table: "user_activity_type" */
    updateUserActivityTypeMany?: (UserActivityTypeMutationResponseGenqlSelection & { __args: {
    /** updates to execute, in order */
...
export interface query_rootGenqlSelection{
    /** fetch data from the table: "board_phase" */
    boardPhase?: (BoardPhaseGenqlSelection & { __args?: {
    /** distinct select on columns */
    ...
    /** fetch aggregated fields from the table: "board_phase" */
    boardPhaseAggregate?: (BoardPhaseAggregateGenqlSelection & { __args?: {
    /** distinct select on columns */
    distinctOn?: (BoardPhaseSelectColumn[] | null), 
    /** limit the number of rows returned */
    limit?: (Scalars['Int'] | null), 
    ...
    where?: (BoardPhaseBoolExp | null)} })
    /** fetch data from the table: "board_phase" using primary key columns */
    boardPhaseByPk?: (BoardPhaseGenqlSelection & { __args: {value: Scalars['String']} })
    /** fetch data from the table: "board_type" */
    boardType?: (BoardTypeGenqlSelection & { __args?: {
    /** distinct select on columns */
    ...
    /** fetch aggregated fields from the table: "board_type" */
    boardTypeAggregate?: (BoardTypeAggregateGenqlSelection & { __args?: {
    /** distinct select on columns */
    distinctOn?: (BoardTypeSelectColumn[] | null), 
    /** limit the number of rows returned */
    limit?: (Scalars['Int'] | null), 
    ...
    where?: (BoardTypeBoolExp | null)} })
    /** fetch data from the table: "board_type" using primary key columns */
    boardTypeByPk?: (BoardTypeGenqlSelection & { __args: {value: Scalars['String']} })
    /** An array relationship */
    boards?: (BoardsGenqlSelection & { __args?: {
    /** distinct select on columns */
    distinctOn?: (BoardsSelectColumn[] | null), 
    ...
    /** fetch data from the table: "user_activity" */
    userActivity?: (UserActivityGenqlSelection & { __args?: {
    /** distinct select on columns */
    ...
    /** fetch aggregated fields from the table: "user_activity" */
    userActivityAggregate?: (UserActivityAggregateGenqlSelection & { __args?: {
    /** distinct select on columns */
    distinctOn?: (UserActivitySelectColumn[] | null), 
    /** limit the number of rows returned */
    limit?: (Scalars['Int'] | null), 
    ...
    where?: (UserActivityBoolExp | null)} })
    /** fetch data from the table: "user_activity" using primary key columns */
    userActivityByPk?: (UserActivityGenqlSelection & { __args: {id: Scalars['uuid']} })
    /** fetch data from the table: "user_activity_type" */
    userActivityType?: (UserActivityTypeGenqlSelection & { __args?: {
    /** distinct select on columns */
    ...
    /** fetch aggregated fields from the table: "user_activity_type" */
    userActivityTypeAggregate?: (UserActivityTypeAggregateGenqlSelection & { __args?: {
    /** distinct select on columns */
    distinctOn?: (UserActivityTypeSelectColumn[] | null), 
    /** limit the number of rows returned */
    limit?: (Scalars['Int'] | null), 
    ...
    where?: (UserActivityTypeBoolExp | null)} })
    /** fetch data from the table: "user_activity_type" using primary key columns */
    userActivityTypeByPk?: (UserActivityTypeGenqlSelection & { __args: {value: Scalars['String']} })
    /** fetch aggregated fields from the table: "user" */
...
export interface subscription_rootGenqlSelection{
    ...
    boardPhaseByPk?: (BoardPhaseGenqlSelection & { __args: {value: Scalars['String']} })
    /** fetch data from the table in a streaming manner: "board_phase" */
    boardPhaseStream?: (BoardPhaseGenqlSelection & { __args: {
    ...
    boardTypeByPk?: (BoardTypeGenqlSelection & { __args: {value: Scalars['String']} })
    /** fetch data from the table in a streaming manner: "board_type" */
    boardTypeStream?: (BoardTypeGenqlSelection & { __args: {
    /** maximum number of rows returned in a single batch */
    batchSize: Scalars['Int'], 
    /** cursor to stream the results returned by the query */
    ...
    boardsByPk?: (BoardsGenqlSelection & { __args: {id: Scalars['uuid']} })
    /** fetch data from the table in a streaming manner: "boards" */
    boardsStream?: (BoardsGenqlSelection & { __args: {
    /** maximum number of rows returned in a single batch */
    batchSize: Scalars['Int'], 
    /** cursor to stream the results returned by the query */
    ...
    commentsByPk?: (CommentsGenqlSelection & { __args: {id: Scalars['uuid']} })
    /** fetch data from the table in a streaming manner: "comments" */
    commentsStream?: (CommentsGenqlSelection & { __args: {
    /** maximum number of rows returned in a single batch */
    batchSize: Scalars['Int'], 
    /** cursor to stream the results returned by the query */
    ...
    userActivityByPk?: (UserActivityGenqlSelection & { __args: {id: Scalars['uuid']} })
    /** fetch data from the table in a streaming manner: "user_activity" */
    userActivityStream?: (UserActivityGenqlSelection & { __args: {
    /** maximum number of rows returned in a single batch */
    batchSize: Scalars['Int'], 
    /** cursor to stream the results returned by the query */
    ...
    userActivityTypeByPk?: (UserActivityTypeGenqlSelection & { __args: {value: Scalars['String']} })
    /** fetch data from the table in a streaming manner: "user_activity_type" */
    userActivityTypeStream?: (UserActivityTypeGenqlSelection & { __args: {
    /** maximum number of rows returned in a single batch */
    batchSize: Scalars['Int'], 
    /** cursor to stream the results returned by the query */
...
export type SubscriptionGenqlSelection = subscription_rootGenqlSelection
    ...
    export const isUserActivityAggregateFields = (obj?: { __typename?: any } | null): obj is UserActivityAggregateFields => {
    ...
    export const isUserActivityMutationResponse = (obj?: { __typename?: any } | null): obj is UserActivityMutationResponse => {
    ...
    export const isUserActivityTypeAggregateFields = (obj?: { __typename?: any } | null): obj is UserActivityTypeAggregateFields => {
    ...
    export const isUserActivityTypeMutationResponse = (obj?: { __typename?: any } | null): obj is UserActivityTypeMutationResponse => {
