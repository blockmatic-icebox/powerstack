    ...
    /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement(
        ...
        /* @__PURE__ */ React.createElement('use', {
          ...
          transform:
            'translate(-0.694656 -0.742424) scale(0.0152672 0.0151515)',
        }),
      ),
      /* @__PURE__ */ React.createElement(
        'pattern',
    ...
    /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement(
        ...
        /* @__PURE__ */ React.createElement(
          ...
          /* @__PURE__ */ React.createElement(BlockmaticIcon_default, null),
        ),
        /* @__PURE__ */ React.createElement(
          Flex,
          {
...
var WalletLogin = () => {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement(PhantonIcon_default, null),
      'Login with Phantom',
    ),
    /* @__PURE__ */ React.createElement(
      Button,
      ...
      /* @__PURE__ */ React.createElement(MetamaskIcon_default, null),
      'Login with Metamask',
    ),
    /* @__PURE__ */ React.createElement(
      Button,
      ...
      /* @__PURE__ */ React.createElement(AnchorIcon_default, null),
      'Login with Anchor',
    ),
    ...
    /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement(
        ...
        /* @__PURE__ */ React.createElement(GitlabIcon_default, null),
      ),
      /* @__PURE__ */ React.createElement(
        Button,
        {
...
var assets_manifest_default = {
  version: '24c9e82d',
  entry: {
    module: '/build/entry.client-SQ3WVRK3.js',
    imports: [
      '/build/_shared/chunk-4ACWVKRS.js',
      '/build/_shared/chunk-K2NYLN3E.js',
  ...
  routes: {
    root: {
      ...
      module: '/build/root-ATPO3SBC.js',
      imports: ['/build/_shared/chunk-NZTGUHDC.js'],
      hasAction: false,
      hasLoader: true,
    ...
    'routes/$account': {
      ...
      index: void 0,
      caseSensitive: void 0,
      module: '/build/routes/$account-7HUZDDZ2.js',
      imports: void 0,
      hasAction: false,
      hasLoader: true,
    ...
    'routes/about': {
      ...
      index: void 0,
      caseSensitive: void 0,
      module: '/build/routes/about-PXPWFFAU.js',
      imports: ['/build/_shared/chunk-7TLTZDD4.js'],
      hasAction: false,
      hasLoader: false,
      hasCatchBoundary: false,
      hasErrorBoundary: false,
    ...
    'routes/actions/login/$strategy': {
      ...
      index: void 0,
      caseSensitive: void 0,
      module: '/build/routes/actions/login/$strategy-A4JWLL7V.js',
      imports: void 0,
      hasAction: true,
      hasLoader: false,
      hasCatchBoundary: false,
    ...
    'routes/index': {
      ...
      index: true,
      caseSensitive: void 0,
      module: '/build/routes/index-SP2WO2SF.js',
      imports: ['/build/_shared/chunk-7TLTZDD4.js'],
      hasAction: false,
      hasLoader: false,
      hasCatchBoundary: false,
  ...
  url: '/build/manifest-24C9E82D.js',
}
